...
// List lists all NsEmigrations in the indexer.
func (s *nsEmigrationLister) List(selector labels.Selector) (ret []*business.NsEmigration, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*business.NsEmigration))
	})
	return ret, err
}
...
// List lists all NsEmigrations in the indexer for a given namespace.
func (s nsEmigrationNamespaceLister) List(selector labels.Selector) (ret []*business.NsEmigration, err error) {
...
// Get retrieves the NsEmigration from the indexer for a given namespace and name.
func (s nsEmigrationNamespaceLister) Get(name string) (*business.NsEmigration, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(business.Resource("nsemigration"), name)
	}
	return obj.(*business.NsEmigration), nil
}

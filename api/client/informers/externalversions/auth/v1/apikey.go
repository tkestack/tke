	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthV1().APIKeys().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthV1().APIKeys().Watch(context.TODO(), options)
			},
		},
		&authv1.APIKey{},
		resyncPeriod,
...
func (f *aPIKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authv1.APIKey{}, f.defaultInformer)
}

func (f *aPIKeyInformer) Lister() v1.APIKeyLister {
	return v1.NewAPIKeyLister(f.Informer().GetIndexer())
}

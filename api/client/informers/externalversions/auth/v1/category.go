	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthV1().Categories().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthV1().Categories().Watch(context.TODO(), options)
			},
		},
		&authv1.Category{},
		resyncPeriod,
...
func (f *categoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authv1.Category{}, f.defaultInformer)
}

	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1().CronHPAs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1().CronHPAs().Watch(context.TODO(), options)
			},
		},
		&platformv1.CronHPA{},
		resyncPeriod,
...
func (f *cronHPAInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1.CronHPA{}, f.defaultInformer)
}

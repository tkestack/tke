...
type Interface interface {
	...
	// MeshManagers returns a MeshManagerInformer.
	MeshManagers() MeshManagerInformer
}
...
// MeshManagers returns a MeshManagerInformer.
func (v *version) MeshManagers() MeshManagerInformer {
	return &meshManagerInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

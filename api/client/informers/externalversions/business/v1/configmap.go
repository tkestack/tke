	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BusinessV1().ConfigMaps().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BusinessV1().ConfigMaps().Watch(context.TODO(), options)
			},
		},
		&businessv1.ConfigMap{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configMapInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&businessv1.ConfigMap{}, f.defaultInformer)
}

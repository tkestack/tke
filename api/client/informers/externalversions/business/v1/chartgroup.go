	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BusinessV1().ChartGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BusinessV1().ChartGroups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *chartGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&businessv1.ChartGroup{}, f.defaultInformer)
}

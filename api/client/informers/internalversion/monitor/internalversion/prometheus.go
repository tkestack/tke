	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Monitor().Prometheuses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Monitor().Prometheuses().Watch(context.TODO(), options)
			},
		},
		&monitor.Prometheus{},
		resyncPeriod,
...
func (f *prometheusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitor.Prometheus{}, f.defaultInformer)
}

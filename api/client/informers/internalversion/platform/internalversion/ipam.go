	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Platform().IPAMs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Platform().IPAMs().Watch(context.TODO(), options)
			},
		},
		&platform.IPAM{},
		resyncPeriod,
...
func (f *iPAMInformer) defaultInformer(client clientsetinternalversion.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *iPAMInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platform.IPAM{}, f.defaultInformer)
}

func (f *iPAMInformer) Lister() internalversion.IPAMLister {
	return internalversion.NewIPAMLister(f.Informer().GetIndexer())
}

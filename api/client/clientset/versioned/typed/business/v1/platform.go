...
type PlatformInterface interface {
	Create(*v1.Platform) (*v1.Platform, error)
	Update(*v1.Platform) (*v1.Platform, error)
	Delete(name string, options *metav1.DeleteOptions) error
	Get(name string, options metav1.GetOptions) (*v1.Platform, error)
	List(opts metav1.ListOptions) (*v1.PlatformList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Platform, err error)
	PlatformExpansion
}
...
func (c *platforms) Get(name string, options metav1.GetOptions) (result *v1.Platform, err error) {
	result = &v1.Platform{}
	err = c.client.Get().
		Resource("platforms").
		Name(name).
...
func (c *platforms) List(opts metav1.ListOptions) (result *v1.PlatformList, err error) {
...
func (c *platforms) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *platforms) Create(platform *v1.Platform) (result *v1.Platform, err error) {
	result = &v1.Platform{}
	err = c.client.Post().
		Resource("platforms").
		Body(platform).
...
func (c *platforms) Update(platform *v1.Platform) (result *v1.Platform, err error) {
	result = &v1.Platform{}
	err = c.client.Put().
		Resource("platforms").
		Name(platform.Name).
...
func (c *platforms) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *platforms) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Platform, err error) {
	result = &v1.Platform{}

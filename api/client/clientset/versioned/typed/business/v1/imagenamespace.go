...
func (c *imageNamespaces) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ImageNamespace, err error) {
...
func (c *imageNamespaces) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ImageNamespaceList, err error) {
...
func (c *imageNamespaces) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageNamespaces) Create(ctx context.Context, imageNamespace *v1.ImageNamespace, opts metav1.CreateOptions) (result *v1.ImageNamespace, err error) {
	result = &v1.ImageNamespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) Update(ctx context.Context, imageNamespace *v1.ImageNamespace, opts metav1.UpdateOptions) (result *v1.ImageNamespace, err error) {
	result = &v1.ImageNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) UpdateStatus(ctx context.Context, imageNamespace *v1.ImageNamespace, opts metav1.UpdateOptions) (result *v1.ImageNamespace, err error) {
	result = &v1.ImageNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *imageNamespaces) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *imageNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ImageNamespace, err error) {
	result = &v1.ImageNamespace{}

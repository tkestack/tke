...
func (c *FakeChartGroups) Get(name string, options v1.GetOptions) (result *registryv1.ChartGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeChartGroups) List(opts v1.ListOptions) (result *registryv1.ChartGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeChartGroups) Create(chartGroup *registryv1.ChartGroup) (result *registryv1.ChartGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeChartGroups) Update(chartGroup *registryv1.ChartGroup) (result *registryv1.ChartGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeChartGroups) UpdateStatus(chartGroup *registryv1.ChartGroup) (*registryv1.ChartGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeChartGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *registryv1.ChartGroup, err error) {
	obj, err := c.Fake.

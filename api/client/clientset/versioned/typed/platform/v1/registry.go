...
type RegistryInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Registry, error)
	List(opts metav1.ListOptions) (*v1.RegistryList, error)
...
func newRegistries(c *PlatformV1Client) *registries {
	return &registries{
		client: c.RESTClient(),
	}
}
...
func (c *registries) Get(name string, options metav1.GetOptions) (result *v1.Registry, err error) {
	result = &v1.Registry{}
	err = c.client.Get().
		Resource("registries").
		Name(name).
...
func (c *registries) List(opts metav1.ListOptions) (result *v1.RegistryList, err error) {
...
func (c *registries) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *registries) Delete(name string, options *metav1.DeleteOptions) error {

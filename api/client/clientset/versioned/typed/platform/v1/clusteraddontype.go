...
type ClusterAddonTypeInterface interface {
	List(opts v1.ListOptions) (*platformv1.ClusterAddonTypeList, error)
...
func newClusterAddonTypes(c *PlatformV1Client) *clusterAddonTypes {
...
func (c *clusterAddonTypes) List(opts v1.ListOptions) (result *platformv1.ClusterAddonTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &platformv1.ClusterAddonTypeList{}
	err = c.client.Get().

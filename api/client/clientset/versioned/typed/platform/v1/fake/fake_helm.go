...
func (c *FakeHelms) Get(ctx context.Context, name string, options v1.GetOptions) (result *platformv1.Helm, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelms) List(ctx context.Context, opts v1.ListOptions) (result *platformv1.HelmList, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelms) Create(ctx context.Context, helm *platformv1.Helm, opts v1.CreateOptions) (result *platformv1.Helm, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelms) Update(ctx context.Context, helm *platformv1.Helm, opts v1.UpdateOptions) (result *platformv1.Helm, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelms) UpdateStatus(ctx context.Context, helm *platformv1.Helm, opts v1.UpdateOptions) (*platformv1.Helm, error) {
	obj, err := c.Fake.
...
func (c *FakeHelms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *platformv1.Helm, err error) {
	obj, err := c.Fake.

...
func (c *FakePersistentEvents) List(ctx context.Context, opts v1.ListOptions) (result *platformv1.PersistentEventList, err error) {
	obj, err := c.Fake.
...
func (c *FakePersistentEvents) UpdateStatus(ctx context.Context, persistentEvent *platformv1.PersistentEvent, opts v1.UpdateOptions) (*platformv1.PersistentEvent, error) {
	obj, err := c.Fake.

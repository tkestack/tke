...
func (c *FakeLBCFs) Get(ctx context.Context, name string, options v1.GetOptions) (result *platformv1.LBCF, err error) {
	obj, err := c.Fake.
...
func (c *FakeLBCFs) List(ctx context.Context, opts v1.ListOptions) (result *platformv1.LBCFList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLBCFs) Create(ctx context.Context, lBCF *platformv1.LBCF, opts v1.CreateOptions) (result *platformv1.LBCF, err error) {
	obj, err := c.Fake.
...
func (c *FakeLBCFs) Update(ctx context.Context, lBCF *platformv1.LBCF, opts v1.UpdateOptions) (result *platformv1.LBCF, err error) {
	obj, err := c.Fake.
...
func (c *FakeLBCFs) UpdateStatus(ctx context.Context, lBCF *platformv1.LBCF, opts v1.UpdateOptions) (*platformv1.LBCF, error) {
	obj, err := c.Fake.
...
func (c *FakeLBCFs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *platformv1.LBCF, err error) {
	obj, err := c.Fake.

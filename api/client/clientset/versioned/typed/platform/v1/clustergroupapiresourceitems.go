...
func newClusterGroupAPIResourceItemses(c *PlatformV1Client) *clusterGroupAPIResourceItemses {
...
func (c *clusterGroupAPIResourceItemses) Get(ctx context.Context, name string, options v1.GetOptions) (result *platformv1.ClusterGroupAPIResourceItems, err error) {
	result = &platformv1.ClusterGroupAPIResourceItems{}
	err = c.client.Get().
...
func (c *clusterGroupAPIResourceItemses) List(ctx context.Context, opts v1.ListOptions) (result *platformv1.ClusterGroupAPIResourceItemsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &platformv1.ClusterGroupAPIResourceItemsList{}
	err = c.client.Get().
		Resource("clustergroupapiresourceitemses").

...
type MachineInterface interface {
	Create(*v1.Machine) (*v1.Machine, error)
	Update(*v1.Machine) (*v1.Machine, error)
	UpdateStatus(*v1.Machine) (*v1.Machine, error)
	Delete(name string, options *metav1.DeleteOptions) error
	Get(name string, options metav1.GetOptions) (*v1.Machine, error)
	List(opts metav1.ListOptions) (*v1.MachineList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Machine, err error)
	MachineExpansion
}
...
func newMachines(c *PlatformV1Client) *machines {
	return &machines{
		client: c.RESTClient(),
	}
}
...
func (c *machines) Get(name string, options metav1.GetOptions) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Get().
		Resource("machines").
		Name(name).
...
func (c *machines) List(opts metav1.ListOptions) (result *v1.MachineList, err error) {
...
func (c *machines) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machines) Create(machine *v1.Machine) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Post().
		Resource("machines").
		Body(machine).
...
func (c *machines) Update(machine *v1.Machine) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Put().
		Resource("machines").
		Name(machine.Name).
...
func (c *machines) UpdateStatus(machine *v1.Machine) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Put().
		Resource("machines").
		Name(machine.Name).
...
func (c *machines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Machine, err error) {
	result = &v1.Machine{}

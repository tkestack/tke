...
func (c *tappControllers) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.TappController, err error) {
...
func (c *tappControllers) List(ctx context.Context, opts metav1.ListOptions) (result *v1.TappControllerList, err error) {
...
func (c *tappControllers) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tappControllers) Create(ctx context.Context, tappController *v1.TappController, opts metav1.CreateOptions) (result *v1.TappController, err error) {
	result = &v1.TappController{}
	err = c.client.Post().
		Resource("tappcontrollers").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *tappControllers) Update(ctx context.Context, tappController *v1.TappController, opts metav1.UpdateOptions) (result *v1.TappController, err error) {
	result = &v1.TappController{}
	err = c.client.Put().
		Resource("tappcontrollers").
...
func (c *tappControllers) UpdateStatus(ctx context.Context, tappController *v1.TappController, opts metav1.UpdateOptions) (result *v1.TappController, err error) {
	result = &v1.TappController{}
	err = c.client.Put().
		Resource("tappcontrollers").
		Name(tappController.Name).
...
func (c *tappControllers) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *tappControllers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.TappController, err error) {
	result = &v1.TappController{}

...
type GroupInterface interface {
	...
	UpdateStatus(ctx context.Context, group *v1.Group, opts metav1.UpdateOptions) (*v1.Group, error)
...
func newGroups(c *AuthV1Client) *groups {
	return &groups{
		client: c.RESTClient(),
	}
}
...
func (c *groups) UpdateStatus(ctx context.Context, group *v1.Group, opts metav1.UpdateOptions) (result *v1.Group, err error) {
	result = &v1.Group{}
	err = c.client.Put().
		Resource("groups").
		Name(group.Name).

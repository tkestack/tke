...
func (c *FakeConfigMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *authv1.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) List(ctx context.Context, opts v1.ListOptions) (result *authv1.ConfigMapList, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Create(ctx context.Context, configMap *authv1.ConfigMap, opts v1.CreateOptions) (result *authv1.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Update(ctx context.Context, configMap *authv1.ConfigMap, opts v1.UpdateOptions) (result *authv1.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *authv1.ConfigMap, err error) {
	obj, err := c.Fake.

...
var appsResource = schema.GroupVersionResource{Group: "application.tkestack.io", Version: "v1", Resource: "apps"}

var appsKind = schema.GroupVersionKind{Group: "application.tkestack.io", Version: "v1", Kind: "App"}
...
func (c *FakeApps) Get(ctx context.Context, name string, options v1.GetOptions) (result *applicationv1.App, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(appsResource, c.ns, name), &applicationv1.App{})

	if obj == nil {
		return nil, err
	}
	return obj.(*applicationv1.App), err
}
...
func (c *FakeApps) List(ctx context.Context, opts v1.ListOptions) (result *applicationv1.AppList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(appsResource, appsKind, c.ns, opts), &applicationv1.AppList{})
	...
	list := &applicationv1.AppList{ListMeta: obj.(*applicationv1.AppList).ListMeta}
	for _, item := range obj.(*applicationv1.AppList).Items {
...
func (c *FakeApps) Create(ctx context.Context, app *applicationv1.App, opts v1.CreateOptions) (result *applicationv1.App, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(appsResource, c.ns, app), &applicationv1.App{})
...
func (c *FakeApps) Update(ctx context.Context, app *applicationv1.App, opts v1.UpdateOptions) (result *applicationv1.App, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(appsResource, c.ns, app), &applicationv1.App{})
...
func (c *FakeApps) UpdateStatus(ctx context.Context, app *applicationv1.App, opts v1.UpdateOptions) (*applicationv1.App, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(appsResource, "status", c.ns, app), &applicationv1.App{})
...
func (c *FakeApps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(appsResource, c.ns, name), &applicationv1.App{})
...
func (c *FakeApps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *applicationv1.App, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(appsResource, c.ns, name, pt, data, subresources...), &applicationv1.App{})

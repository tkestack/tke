...
var configmapsResource = schema.GroupVersionResource{Group: "application.tkestack.io", Version: "v1", Resource: "configmaps"}

var configmapsKind = schema.GroupVersionKind{Group: "application.tkestack.io", Version: "v1", Kind: "ConfigMap"}
...
func (c *FakeConfigMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *applicationv1.ConfigMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(configmapsResource, name), &applicationv1.ConfigMap{})
	if obj == nil {
		return nil, err
	}
	return obj.(*applicationv1.ConfigMap), err
}
...
func (c *FakeConfigMaps) List(ctx context.Context, opts v1.ListOptions) (result *applicationv1.ConfigMapList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(configmapsResource, configmapsKind, opts), &applicationv1.ConfigMapList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &applicationv1.ConfigMapList{ListMeta: obj.(*applicationv1.ConfigMapList).ListMeta}
	for _, item := range obj.(*applicationv1.ConfigMapList).Items {
...
func (c *FakeConfigMaps) Create(ctx context.Context, configMap *applicationv1.ConfigMap, opts v1.CreateOptions) (result *applicationv1.ConfigMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(configmapsResource, configMap), &applicationv1.ConfigMap{})
	if obj == nil {
		return nil, err
	}
	return obj.(*applicationv1.ConfigMap), err
...
func (c *FakeConfigMaps) Update(ctx context.Context, configMap *applicationv1.ConfigMap, opts v1.UpdateOptions) (result *applicationv1.ConfigMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(configmapsResource, configMap), &applicationv1.ConfigMap{})
	if obj == nil {
		return nil, err
	}
	return obj.(*applicationv1.ConfigMap), err
...
func (c *FakeConfigMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(configmapsResource, name), &applicationv1.ConfigMap{})
	return err
}
...
func (c *FakeConfigMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *applicationv1.ConfigMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(configmapsResource, name, pt, data, subresources...), &applicationv1.ConfigMap{})
	if obj == nil {
		return nil, err
	}
	return obj.(*applicationv1.ConfigMap), err

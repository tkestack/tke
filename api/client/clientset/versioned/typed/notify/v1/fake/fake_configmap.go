...
var configmapsResource = schema.GroupVersionResource{Group: "notify.tkestack.io", Version: "v1", Resource: "configmaps"}
...
func (c *FakeConfigMaps) Get(name string, options v1.GetOptions) (result *notifyv1.ConfigMap, err error) {
	...
	return obj.(*notifyv1.ConfigMap), err
}
...
func (c *FakeConfigMaps) List(opts v1.ListOptions) (result *notifyv1.ConfigMapList, err error) {
	...
	list := &notifyv1.ConfigMapList{ListMeta: obj.(*notifyv1.ConfigMapList).ListMeta}
	for _, item := range obj.(*notifyv1.ConfigMapList).Items {

...
type ImageNamespaceInterface interface {
	Create(*business.ImageNamespace) (*business.ImageNamespace, error)
	...
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *business.ImageNamespace, err error)
...
func (c *imageNamespaces) Get(name string, options v1.GetOptions) (result *business.ImageNamespace, err error) {
...
func (c *imageNamespaces) List(opts v1.ListOptions) (result *business.ImageNamespaceList, err error) {
...
func (c *imageNamespaces) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageNamespaces) Create(imageNamespace *business.ImageNamespace) (result *business.ImageNamespace, err error) {
	result = &business.ImageNamespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) Update(imageNamespace *business.ImageNamespace) (result *business.ImageNamespace, err error) {
	result = &business.ImageNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) UpdateStatus(imageNamespace *business.ImageNamespace) (result *business.ImageNamespace, err error) {
	result = &business.ImageNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagenamespaces").
...
func (c *imageNamespaces) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *imageNamespaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *business.ImageNamespace, err error) {
	result = &business.ImageNamespace{}

...
var projectsResource = schema.GroupVersionResource{Group: "business.tkestack.io", Version: "", Resource: "projects"}
...
func (c *FakeProjects) Get(name string, options v1.GetOptions) (result *business.Project, err error) {
	...
	return obj.(*business.Project), err
}
...
func (c *FakeProjects) List(opts v1.ListOptions) (result *business.ProjectList, err error) {
	...
	list := &business.ProjectList{ListMeta: obj.(*business.ProjectList).ListMeta}
	for _, item := range obj.(*business.ProjectList).Items {

...
func NewForConfig(c *rest.Config) (*LogagentClient, error) {
	...
	return &LogagentClient{client}, nil
}

// NewForConfigOrDie creates a new LogagentClient for the given config and
...
func New(c rest.Interface) *LogagentClient {
	return &LogagentClient{c}
}
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("logagent.tkestack.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("logagent.tkestack.io")[0]

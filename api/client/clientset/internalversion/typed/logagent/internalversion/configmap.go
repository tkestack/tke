...
func (c *configMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *logagent.ConfigMap, err error) {
...
func (c *configMaps) List(ctx context.Context, opts v1.ListOptions) (result *logagent.ConfigMapList, err error) {
...
func (c *configMaps) Create(ctx context.Context, configMap *logagent.ConfigMap, opts v1.CreateOptions) (result *logagent.ConfigMap, err error) {
	result = &logagent.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *configMaps) Update(ctx context.Context, configMap *logagent.ConfigMap, opts v1.UpdateOptions) (result *logagent.ConfigMap, err error) {
	result = &logagent.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *logagent.ConfigMap, err error) {
	result = &logagent.ConfigMap{}

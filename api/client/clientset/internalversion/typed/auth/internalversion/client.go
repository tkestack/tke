...
func (c *clients) Get(ctx context.Context, name string, options v1.GetOptions) (result *auth.Client, err error) {
	result = &auth.Client{}
	err = c.client.Get().
		Resource("clients").
		Name(name).
...
func (c *clients) List(ctx context.Context, opts v1.ListOptions) (result *auth.ClientList, err error) {
...
func (c *clients) Create(ctx context.Context, client *auth.Client, opts v1.CreateOptions) (result *auth.Client, err error) {
	result = &auth.Client{}
	err = c.client.Post().
		Resource("clients").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clients) Update(ctx context.Context, client *auth.Client, opts v1.UpdateOptions) (result *auth.Client, err error) {
	result = &auth.Client{}
	err = c.client.Put().
		Resource("clients").
		Name(client.Name).
...
func (c *clients) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *auth.Client, err error) {
	result = &auth.Client{}

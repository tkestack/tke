...
var projectsResource = schema.GroupVersionResource{Group: "auth.tkestack.io", Version: "", Resource: "projects"}
...
func (c *FakeProjects) List(ctx context.Context, opts v1.ListOptions) (result *auth.ProjectList, err error) {
	...
	list := &auth.ProjectList{ListMeta: obj.(*auth.ProjectList).ListMeta}
	for _, item := range obj.(*auth.ProjectList).Items {

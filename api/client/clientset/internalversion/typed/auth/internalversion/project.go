...
func (c *projects) Get(ctx context.Context, name string, options v1.GetOptions) (result *auth.Project, err error) {
	result = &auth.Project{}
	err = c.client.Get().
		Resource("projects").
		Name(name).
...
func (c *projects) List(ctx context.Context, opts v1.ListOptions) (result *auth.ProjectList, err error) {
...
func (c *projects) Create(ctx context.Context, project *auth.Project, opts v1.CreateOptions) (result *auth.Project, err error) {
	result = &auth.Project{}
	err = c.client.Post().
		Resource("projects").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *projects) Update(ctx context.Context, project *auth.Project, opts v1.UpdateOptions) (result *auth.Project, err error) {
	result = &auth.Project{}
	err = c.client.Put().
		Resource("projects").
		Name(project.Name).
...
func (c *projects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *auth.Project, err error) {
	result = &auth.Project{}

...
func newConfigMaps(c *AuthClient) *configMaps {
	return &configMaps{
		client: c.RESTClient(),
	}
}
...
func (c *configMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}
	err = c.client.Get().
		Resource("configmaps").
		Name(name).
...
func (c *configMaps) List(ctx context.Context, opts v1.ListOptions) (result *auth.ConfigMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &auth.ConfigMapList{}
	err = c.client.Get().
		Resource("configmaps").
...
func (c *configMaps) Create(ctx context.Context, configMap *auth.ConfigMap, opts v1.CreateOptions) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *configMaps) Update(ctx context.Context, configMap *auth.ConfigMap, opts v1.UpdateOptions) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}

...
func (c *configMaps) Get(name string, options v1.GetOptions) (result *auth.ConfigMap, err error) {
...
func (c *configMaps) List(opts v1.ListOptions) (result *auth.ConfigMapList, err error) {
...
func (c *configMaps) Create(configMap *auth.ConfigMap) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		Body(configMap).
...
func (c *configMaps) Update(configMap *auth.ConfigMap) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *auth.ConfigMap, err error) {
	result = &auth.ConfigMap{}

...
func (c *localGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *auth.LocalGroup, err error) {
...
func (c *localGroups) List(ctx context.Context, opts v1.ListOptions) (result *auth.LocalGroupList, err error) {
...
func (c *localGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *localGroups) Create(ctx context.Context, localGroup *auth.LocalGroup, opts v1.CreateOptions) (result *auth.LocalGroup, err error) {
	result = &auth.LocalGroup{}
	err = c.client.Post().
		Resource("localgroups").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *localGroups) Update(ctx context.Context, localGroup *auth.LocalGroup, opts v1.UpdateOptions) (result *auth.LocalGroup, err error) {
	result = &auth.LocalGroup{}
	err = c.client.Put().
		Resource("localgroups").
...
func (c *localGroups) UpdateStatus(ctx context.Context, localGroup *auth.LocalGroup, opts v1.UpdateOptions) (result *auth.LocalGroup, err error) {
	result = &auth.LocalGroup{}
	err = c.client.Put().
		Resource("localgroups").
		Name(localGroup.Name).
...
func (c *localGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *localGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *localGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *auth.LocalGroup, err error) {
	result = &auth.LocalGroup{}

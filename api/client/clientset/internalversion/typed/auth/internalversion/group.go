...
func (c *groups) Get(name string, options v1.GetOptions) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Get().
		Resource("groups").
		Name(name).
...
func (c *groups) List(opts v1.ListOptions) (result *auth.GroupList, err error) {
...
func (c *groups) Create(group *auth.Group) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Post().
		Resource("groups").
		Body(group).
...
func (c *groups) Update(group *auth.Group) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Put().
		Resource("groups").
		Name(group.Name).
...
func (c *groups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *auth.Group, err error) {
	result = &auth.Group{}

...
func newGroups(c *AuthClient) *groups {
	return &groups{
		client: c.RESTClient(),
	}
}
...
func (c *groups) Get(ctx context.Context, name string, options v1.GetOptions) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Get().
		Resource("groups").
		Name(name).
...
func (c *groups) List(ctx context.Context, opts v1.ListOptions) (result *auth.GroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &auth.GroupList{}
	err = c.client.Get().
		Resource("groups").
...
func (c *groups) Create(ctx context.Context, group *auth.Group, opts v1.CreateOptions) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Post().
		Resource("groups").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *groups) Update(ctx context.Context, group *auth.Group, opts v1.UpdateOptions) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Put().
		Resource("groups").
		Name(group.Name).
...
func (c *groups) UpdateStatus(ctx context.Context, group *auth.Group, opts v1.UpdateOptions) (result *auth.Group, err error) {
	result = &auth.Group{}
	err = c.client.Put().
		Resource("groups").
		Name(group.Name).
...
func (c *groups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *auth.Group, err error) {
	result = &auth.Group{}

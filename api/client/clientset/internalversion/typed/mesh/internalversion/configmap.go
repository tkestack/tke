...
func newConfigMaps(c *MeshClient) *configMaps {
	return &configMaps{
		client: c.RESTClient(),
	}
}
...
func (c *configMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *mesh.ConfigMap, err error) {
	result = &mesh.ConfigMap{}
	err = c.client.Get().
		Resource("configmaps").
		Name(name).
...
func (c *configMaps) List(ctx context.Context, opts v1.ListOptions) (result *mesh.ConfigMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &mesh.ConfigMapList{}
	err = c.client.Get().
		Resource("configmaps").
...
func (c *configMaps) Create(ctx context.Context, configMap *mesh.ConfigMap, opts v1.CreateOptions) (result *mesh.ConfigMap, err error) {
	result = &mesh.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *configMaps) Update(ctx context.Context, configMap *mesh.ConfigMap, opts v1.UpdateOptions) (result *mesh.ConfigMap, err error) {
	result = &mesh.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *mesh.ConfigMap, err error) {
	result = &mesh.ConfigMap{}

...
func (c *logCollectors) Get(name string, options v1.GetOptions) (result *platform.LogCollector, err error) {
...
func (c *logCollectors) List(opts v1.ListOptions) (result *platform.LogCollectorList, err error) {
...
func (c *logCollectors) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logCollectors) Create(logCollector *platform.LogCollector) (result *platform.LogCollector, err error) {
	result = &platform.LogCollector{}
	err = c.client.Post().
		Resource("logcollectors").
		Body(logCollector).
...
func (c *logCollectors) Update(logCollector *platform.LogCollector) (result *platform.LogCollector, err error) {
	result = &platform.LogCollector{}
	err = c.client.Put().
		Resource("logcollectors").
...
func (c *logCollectors) UpdateStatus(logCollector *platform.LogCollector) (result *platform.LogCollector, err error) {
	result = &platform.LogCollector{}
	err = c.client.Put().
		Resource("logcollectors").
		Name(logCollector.Name).
...
func (c *logCollectors) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *logCollectors) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *platform.LogCollector, err error) {
	result = &platform.LogCollector{}

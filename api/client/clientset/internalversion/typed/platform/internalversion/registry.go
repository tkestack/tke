...
func (c *registries) Get(name string, options v1.GetOptions) (result *platform.Registry, err error) {
...
func (c *registries) List(opts v1.ListOptions) (result *platform.RegistryList, err error) {
...
func (c *registries) Create(registry *platform.Registry) (result *platform.Registry, err error) {
	result = &platform.Registry{}
	err = c.client.Post().
		Resource("registries").
		Body(registry).
...
func (c *registries) Update(registry *platform.Registry) (result *platform.Registry, err error) {
	result = &platform.Registry{}
	err = c.client.Put().
		Resource("registries").
		Name(registry.Name).
...
func (c *registries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *platform.Registry, err error) {
	result = &platform.Registry{}

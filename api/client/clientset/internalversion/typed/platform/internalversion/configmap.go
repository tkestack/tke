...
func (c *configMaps) Get(name string, options v1.GetOptions) (result *platform.ConfigMap, err error) {
...
func (c *configMaps) List(opts v1.ListOptions) (result *platform.ConfigMapList, err error) {
...
func (c *configMaps) Create(configMap *platform.ConfigMap) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		Body(configMap).
...
func (c *configMaps) Update(configMap *platform.ConfigMap) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}

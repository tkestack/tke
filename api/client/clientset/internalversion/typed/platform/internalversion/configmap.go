...
func newConfigMaps(c *PlatformClient) *configMaps {
	return &configMaps{
		client: c.RESTClient(),
	}
}
...
func (c *configMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}
	err = c.client.Get().
		Resource("configmaps").
		Name(name).
...
func (c *configMaps) List(ctx context.Context, opts v1.ListOptions) (result *platform.ConfigMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &platform.ConfigMapList{}
	err = c.client.Get().
		Resource("configmaps").
...
func (c *configMaps) Create(ctx context.Context, configMap *platform.ConfigMap, opts v1.CreateOptions) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}
	err = c.client.Post().
		Resource("configmaps").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *configMaps) Update(ctx context.Context, configMap *platform.ConfigMap, opts v1.UpdateOptions) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}
	err = c.client.Put().
		Resource("configmaps").
		Name(configMap.Name).
...
func (c *configMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *platform.ConfigMap, err error) {
	result = &platform.ConfigMap{}

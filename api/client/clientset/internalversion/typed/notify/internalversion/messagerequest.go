...
func (c *messageRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *notify.MessageRequest, err error) {
...
func (c *messageRequests) List(ctx context.Context, opts v1.ListOptions) (result *notify.MessageRequestList, err error) {
...
func (c *messageRequests) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *messageRequests) Create(ctx context.Context, messageRequest *notify.MessageRequest, opts v1.CreateOptions) (result *notify.MessageRequest, err error) {
	result = &notify.MessageRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("messagerequests").
...
func (c *messageRequests) Update(ctx context.Context, messageRequest *notify.MessageRequest, opts v1.UpdateOptions) (result *notify.MessageRequest, err error) {
	result = &notify.MessageRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("messagerequests").
...
func (c *messageRequests) UpdateStatus(ctx context.Context, messageRequest *notify.MessageRequest, opts v1.UpdateOptions) (result *notify.MessageRequest, err error) {
	result = &notify.MessageRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("messagerequests").
...
func (c *messageRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *messageRequests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *messageRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *notify.MessageRequest, err error) {
	result = &notify.MessageRequest{}

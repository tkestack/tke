...
func (c *FakeChannels) Get(name string, options v1.GetOptions) (result *notify.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) List(opts v1.ListOptions) (result *notify.ChannelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Create(channel *notify.Channel) (result *notify.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Update(channel *notify.Channel) (result *notify.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) UpdateStatus(channel *notify.Channel) (*notify.Channel, error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *notify.Channel, err error) {
	obj, err := c.Fake.

...
func newApps(c *ApplicationClient, namespace string) *apps {
	return &apps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apps) Get(ctx context.Context, name string, options v1.GetOptions) (result *application.App, err error) {
...
func (c *apps) List(ctx context.Context, opts v1.ListOptions) (result *application.AppList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &application.AppList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apps").
...
func (c *apps) Create(ctx context.Context, app *application.App, opts v1.CreateOptions) (result *application.App, err error) {
	result = &application.App{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apps").
...
func (c *apps) Update(ctx context.Context, app *application.App, opts v1.UpdateOptions) (result *application.App, err error) {
	result = &application.App{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apps").
...
func (c *apps) UpdateStatus(ctx context.Context, app *application.App, opts v1.UpdateOptions) (result *application.App, err error) {
	result = &application.App{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apps").
...
func (c *apps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *application.App, err error) {
	result = &application.App{}

...
type RepositoryInterface interface {
	Create(ctx context.Context, repository *registry.Repository, opts v1.CreateOptions) (*registry.Repository, error)
	Update(ctx context.Context, repository *registry.Repository, opts v1.UpdateOptions) (*registry.Repository, error)
	UpdateStatus(ctx context.Context, repository *registry.Repository, opts v1.UpdateOptions) (*registry.Repository, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*registry.Repository, error)
	List(ctx context.Context, opts v1.ListOptions) (*registry.RepositoryList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *registry.Repository, err error)
	RepositoryExpansion
}
...
func (c *repositories) Get(ctx context.Context, name string, options v1.GetOptions) (result *registry.Repository, err error) {
...
func (c *repositories) List(ctx context.Context, opts v1.ListOptions) (result *registry.RepositoryList, err error) {
...
func (c *repositories) Create(ctx context.Context, repository *registry.Repository, opts v1.CreateOptions) (result *registry.Repository, err error) {
	result = &registry.Repository{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Update(ctx context.Context, repository *registry.Repository, opts v1.UpdateOptions) (result *registry.Repository, err error) {
	result = &registry.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) UpdateStatus(ctx context.Context, repository *registry.Repository, opts v1.UpdateOptions) (result *registry.Repository, err error) {
	result = &registry.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *registry.Repository, err error) {
	result = &registry.Repository{}

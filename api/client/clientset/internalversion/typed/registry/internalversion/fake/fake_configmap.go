...
func (c *FakeConfigMaps) Get(name string, options v1.GetOptions) (result *registry.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) List(opts v1.ListOptions) (result *registry.ConfigMapList, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Create(configMap *registry.ConfigMap) (result *registry.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Update(configMap *registry.ConfigMap) (result *registry.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *registry.ConfigMap, err error) {
	obj, err := c.Fake.

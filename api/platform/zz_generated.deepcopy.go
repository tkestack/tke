...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ClusterApps) DeepCopyInto(out *ClusterApps) {
	{
		in := &in
		*out = make(ClusterApps, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterApps.
func (in ClusterApps) DeepCopy() ClusterApps {
	if in == nil {
		return nil
	}
	out := new(ClusterApps)
...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.ClusterApps != nil {
		in, out := &in.ClusterApps, &out.ClusterApps
		*out = make(ClusterApps, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}

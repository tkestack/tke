...
type ImpersonationConfig struct {
	...
	// +optional
	Extra string `json:"extra,omitempty" protobuf:"bytes,3,opt,name=extra"`
}

func (i *ImpersonationConfig) ExtraToMap() map[string][]string {
	res := map[string][]string{}
	json.Unmarshal([]byte(i.Extra), &res)
	return res
}

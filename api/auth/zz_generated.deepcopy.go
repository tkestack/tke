...
func (in *CustomPolicyBindingList) DeepCopyInto(out *CustomPolicyBindingList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]CustomPolicyBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CustomPolicyBindingList) DeepCopy() *CustomPolicyBindingList {
	...
	out := new(CustomPolicyBindingList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomPolicyBindingSpec) DeepCopy() *CustomPolicyBindingSpec {
	...
	out := new(CustomPolicyBindingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomPolicyBindingStatus) DeepCopy() *CustomPolicyBindingStatus {
	...
	out := new(CustomPolicyBindingStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectBelongs) DeepCopyInto(out *ProjectBelongs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.ManagedProjects != nil {
		in, out := &in.ManagedProjects, &out.ManagedProjects
	...
	if in.MemberdProjects != nil {
		in, out := &in.MemberdProjects, &out.MemberdProjects
		*out = make(map[string]ExtraValue, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
...
func (in *ProjectPolicyBindingList) DeepCopyInto(out *ProjectPolicyBindingList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ProjectPolicyBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ProjectPolicyBindingList) DeepCopy() *ProjectPolicyBindingList {
	...
	out := new(ProjectPolicyBindingList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectPolicyBindingRequest) DeepCopy() *ProjectPolicyBindingRequest {
	...
	out := new(ProjectPolicyBindingRequest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectPolicyBindingSpec) DeepCopy() *ProjectPolicyBindingSpec {
	...
	out := new(ProjectPolicyBindingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectPolicyBindingStatus) DeepCopy() *ProjectPolicyBindingStatus {
	...
	out := new(ProjectPolicyBindingStatus)
	in.DeepCopyInto(out)
	return out
}

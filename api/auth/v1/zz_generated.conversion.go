...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CustomPolicyBinding)(nil), (*auth.CustomPolicyBinding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CustomPolicyBinding_To_auth_CustomPolicyBinding(a.(*CustomPolicyBinding), b.(*auth.CustomPolicyBinding), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auth.CustomPolicyBinding)(nil), (*CustomPolicyBinding)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auth_CustomPolicyBinding_To_v1_CustomPolicyBinding(a.(*auth.CustomPolicyBinding), b.(*CustomPolicyBinding), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomPolicyBindingList)(nil), (*auth.CustomPolicyBindingList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CustomPolicyBindingList_To_auth_CustomPolicyBindingList(a.(*CustomPolicyBindingList), b.(*auth.CustomPolicyBindingList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auth.CustomPolicyBindingList)(nil), (*CustomPolicyBindingList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auth_CustomPolicyBindingList_To_v1_CustomPolicyBindingList(a.(*auth.CustomPolicyBindingList), b.(*CustomPolicyBindingList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomPolicyBindingSpec)(nil), (*auth.CustomPolicyBindingSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CustomPolicyBindingSpec_To_auth_CustomPolicyBindingSpec(a.(*CustomPolicyBindingSpec), b.(*auth.CustomPolicyBindingSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auth.CustomPolicyBindingSpec)(nil), (*CustomPolicyBindingSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auth_CustomPolicyBindingSpec_To_v1_CustomPolicyBindingSpec(a.(*auth.CustomPolicyBindingSpec), b.(*CustomPolicyBindingSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomPolicyBindingStatus)(nil), (*auth.CustomPolicyBindingStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CustomPolicyBindingStatus_To_auth_CustomPolicyBindingStatus(a.(*CustomPolicyBindingStatus), b.(*auth.CustomPolicyBindingStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auth.CustomPolicyBindingStatus)(nil), (*CustomPolicyBindingStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auth_CustomPolicyBindingStatus_To_v1_CustomPolicyBindingStatus(a.(*auth.CustomPolicyBindingStatus), b.(*CustomPolicyBindingStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_CustomPolicyBinding_To_auth_CustomPolicyBinding(in *CustomPolicyBinding, out *auth.CustomPolicyBinding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_CustomPolicyBindingSpec_To_auth_CustomPolicyBindingSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_CustomPolicyBindingStatus_To_auth_CustomPolicyBindingStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func Convert_v1_CustomPolicyBinding_To_auth_CustomPolicyBinding(in *CustomPolicyBinding, out *auth.CustomPolicyBinding, s conversion.Scope) error {
	return autoConvert_v1_CustomPolicyBinding_To_auth_CustomPolicyBinding(in, out, s)
}

func autoConvert_auth_CustomPolicyBinding_To_v1_CustomPolicyBinding(in *auth.CustomPolicyBinding, out *CustomPolicyBinding, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_auth_CustomPolicyBindingSpec_To_v1_CustomPolicyBindingSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_auth_CustomPolicyBindingStatus_To_v1_CustomPolicyBindingStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func Convert_auth_CustomPolicyBinding_To_v1_CustomPolicyBinding(in *auth.CustomPolicyBinding, out *CustomPolicyBinding, s conversion.Scope) error {
	return autoConvert_auth_CustomPolicyBinding_To_v1_CustomPolicyBinding(in, out, s)
}

func autoConvert_v1_CustomPolicyBindingList_To_auth_CustomPolicyBindingList(in *CustomPolicyBindingList, out *auth.CustomPolicyBindingList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]auth.CustomPolicyBinding)(unsafe.Pointer(&in.Items))
	return nil
}
...
func Convert_v1_CustomPolicyBindingList_To_auth_CustomPolicyBindingList(in *CustomPolicyBindingList, out *auth.CustomPolicyBindingList, s conversion.Scope) error {
	return autoConvert_v1_CustomPolicyBindingList_To_auth_CustomPolicyBindingList(in, out, s)
}

func autoConvert_auth_CustomPolicyBindingList_To_v1_CustomPolicyBindingList(in *auth.CustomPolicyBindingList, out *CustomPolicyBindingList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]CustomPolicyBinding)(unsafe.Pointer(&in.Items))
	return nil
}
...
func Convert_auth_CustomPolicyBindingList_To_v1_CustomPolicyBindingList(in *auth.CustomPolicyBindingList, out *CustomPolicyBindingList, s conversion.Scope) error {
	return autoConvert_auth_CustomPolicyBindingList_To_v1_CustomPolicyBindingList(in, out, s)
}

func autoConvert_v1_CustomPolicyBindingSpec_To_auth_CustomPolicyBindingSpec(in *CustomPolicyBindingSpec, out *auth.CustomPolicyBindingSpec, s conversion.Scope) error {
	out.Finalizers = *(*[]auth.FinalizerName)(unsafe.Pointer(&in.Finalizers))
	out.TenantID = in.TenantID
	out.Domain = in.Domain
	out.LastDomain = in.LastDomain
	out.PolicyID = in.PolicyID
	out.Resources = *(*[]string)(unsafe.Pointer(&in.Resources))
	out.RulePrefix = in.RulePrefix
	out.Users = *(*[]auth.Subject)(unsafe.Pointer(&in.Users))
	out.Groups = *(*[]auth.Subject)(unsafe.Pointer(&in.Groups))
	return nil
}
...
func Convert_v1_CustomPolicyBindingSpec_To_auth_CustomPolicyBindingSpec(in *CustomPolicyBindingSpec, out *auth.CustomPolicyBindingSpec, s conversion.Scope) error {
	return autoConvert_v1_CustomPolicyBindingSpec_To_auth_CustomPolicyBindingSpec(in, out, s)
}

func autoConvert_auth_CustomPolicyBindingSpec_To_v1_CustomPolicyBindingSpec(in *auth.CustomPolicyBindingSpec, out *CustomPolicyBindingSpec, s conversion.Scope) error {
...
func Convert_auth_CustomPolicyBindingSpec_To_v1_CustomPolicyBindingSpec(in *auth.CustomPolicyBindingSpec, out *CustomPolicyBindingSpec, s conversion.Scope) error {
	return autoConvert_auth_CustomPolicyBindingSpec_To_v1_CustomPolicyBindingSpec(in, out, s)
}

func autoConvert_v1_CustomPolicyBindingStatus_To_auth_CustomPolicyBindingStatus(in *CustomPolicyBindingStatus, out *auth.CustomPolicyBindingStatus, s conversion.Scope) error {
...
func Convert_v1_CustomPolicyBindingStatus_To_auth_CustomPolicyBindingStatus(in *CustomPolicyBindingStatus, out *auth.CustomPolicyBindingStatus, s conversion.Scope) error {
	return autoConvert_v1_CustomPolicyBindingStatus_To_auth_CustomPolicyBindingStatus(in, out, s)
}

func autoConvert_auth_CustomPolicyBindingStatus_To_v1_CustomPolicyBindingStatus(in *auth.CustomPolicyBindingStatus, out *CustomPolicyBindingStatus, s conversion.Scope) error {
...
func Convert_auth_CustomPolicyBindingStatus_To_v1_CustomPolicyBindingStatus(in *auth.CustomPolicyBindingStatus, out *CustomPolicyBindingStatus, s conversion.Scope) error {
	return autoConvert_auth_CustomPolicyBindingStatus_To_v1_CustomPolicyBindingStatus(in, out, s)
}

...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HealthCheckDetail)(nil), (*application.HealthCheckDetail)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HealthCheckDetail_To_application_HealthCheckDetail(a.(*HealthCheckDetail), b.(*application.HealthCheckDetail), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*application.HealthCheckDetail)(nil), (*HealthCheckDetail)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_application_HealthCheckDetail_To_v1_HealthCheckDetail(a.(*application.HealthCheckDetail), b.(*HealthCheckDetail), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_AppStatus_To_application_AppStatus(in *AppStatus, out *application.AppStatus, s conversion.Scope) error {
	...
	out.LastHealthCheckTime = in.LastHealthCheckTime
	out.HealthCheckDetails = *(*[]application.HealthCheckDetail)(unsafe.Pointer(&in.HealthCheckDetails))
	return nil
}
...
func autoConvert_application_AppStatus_To_v1_AppStatus(in *application.AppStatus, out *AppStatus, s conversion.Scope) error {
	...
	out.HealthStatus = in.HealthStatus
	out.LastHealthCheckTime = in.LastHealthCheckTime
	out.HealthCheckDetails = *(*[]HealthCheckDetail)(unsafe.Pointer(&in.HealthCheckDetails))
	return nil
}
...
func autoConvert_v1_HealthCheckDetail_To_application_HealthCheckDetail(in *HealthCheckDetail, out *application.HealthCheckDetail, s conversion.Scope) error {
	out.WorkloadType = in.WorkloadType
	out.WorkloadName = in.WorkloadName
	out.PodDesiredNum = in.PodDesiredNum
	out.PodReadyNum = in.PodReadyNum
	return nil
}

// Convert_v1_HealthCheckDetail_To_application_HealthCheckDetail is an autogenerated conversion function.
func Convert_v1_HealthCheckDetail_To_application_HealthCheckDetail(in *HealthCheckDetail, out *application.HealthCheckDetail, s conversion.Scope) error {
	return autoConvert_v1_HealthCheckDetail_To_application_HealthCheckDetail(in, out, s)
}

func autoConvert_application_HealthCheckDetail_To_v1_HealthCheckDetail(in *application.HealthCheckDetail, out *HealthCheckDetail, s conversion.Scope) error {
	out.WorkloadType = in.WorkloadType
	out.WorkloadName = in.WorkloadName
	out.PodDesiredNum = in.PodDesiredNum
	out.PodReadyNum = in.PodReadyNum
...
// Convert_application_HealthCheckDetail_To_v1_HealthCheckDetail is an autogenerated conversion function.
func Convert_application_HealthCheckDetail_To_v1_HealthCheckDetail(in *application.HealthCheckDetail, out *HealthCheckDetail, s conversion.Scope) error {
	return autoConvert_application_HealthCheckDetail_To_v1_HealthCheckDetail(in, out, s)
}

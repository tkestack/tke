...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&MeshManager{}, func(obj interface{}) { SetObjectDefaults_MeshManager(obj.(*MeshManager)) })
	scheme.AddTypeDefaultingFunc(&MeshManagerList{}, func(obj interface{}) { SetObjectDefaults_MeshManagerList(obj.(*MeshManagerList)) })
	return nil
}
...
func SetObjectDefaults_MeshManager(in *MeshManager) {
	SetDefaults_MeshManagerStatus(&in.Status)
}

func SetObjectDefaults_MeshManagerList(in *MeshManagerList) {
	for i := range in.Items {
		a := &in.Items[i]
		SetObjectDefaults_MeshManager(a)
	}
}

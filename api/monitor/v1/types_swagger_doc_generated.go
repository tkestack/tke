...
var map_AlarmPolicy = map[string]string{
	"":     "AlarmPolicy is a policy of alarm system.",
	"spec": "Spec defines the desired identities of alarm policies in this set.",
}

func (AlarmPolicy) SwaggerDoc() map[string]string {
	return map_AlarmPolicy
}

var map_AlarmPolicyList = map[string]string{
	"":      "AlarmPolicyList is the whole list of all alarm policies which owned by a tenant.",
	"items": "List of alarm policies.",
}

func (AlarmPolicyList) SwaggerDoc() map[string]string {
	return map_AlarmPolicyList
}

var map_AlarmPolicySpec = map[string]string{
	"": "AlarmPolicySpec describes the attributes on an alarm policy.",
}

func (AlarmPolicySpec) SwaggerDoc() map[string]string {
	return map_AlarmPolicySpec
}

var map_AlarmPolicyStatus = map[string]string{
...
func (AlarmPolicyStatus) SwaggerDoc() map[string]string {
	return map_AlarmPolicyStatus
}

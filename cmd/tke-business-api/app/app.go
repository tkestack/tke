...
const commandDesc = `The Business API server validates and configures data for the api objects which 
include project, platform, and others. The API Server services REST operations 
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Business API Server", basename,

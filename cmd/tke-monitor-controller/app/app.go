...
const commandDesc = `The monitor controller manager is a daemon that embeds the core control loops. In 
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Monitor Controller Manager",
		basename,

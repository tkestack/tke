...
const commandDesc = `The TKE Auth provides a unified authentication adn authorization interface. In addtion to 
service as a OIDC backend server and a local identity provider, it also provides the frontend to the policies and roles 
management.`

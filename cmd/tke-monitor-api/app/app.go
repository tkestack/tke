...
import (
	...
	"tkestack.io/tke/cmd/tke-monitor-api/app/config"
	"tkestack.io/tke/cmd/tke-monitor-api/app/options"
	"tkestack.io/tke/pkg/app"
	"tkestack.io/tke/pkg/util/log"
)

const commandDesc = `The TKE monitor module is a standalone web server that provides cluster and project
monitor data related API interfaces.`

// NewApp creates a App object with default parameters.
func NewApp(basename string) *app.App {
	opts := options.NewOptions(basename)
	application := app.NewApp("Tencent Kubernetes Engine Monitor API Server",
		basename,

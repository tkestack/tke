...
const commandDesc = `The TKE mesh module is a standalone web server that provides cluster and project
mesh data related API interfaces.`

// NewApp creates a App object with default parameters.
func NewApp(basename string) *app.App {
	opts := options.NewOptions(basename)
	application := app.NewApp("Tencent Kubernetes Engine Mesh API Server",
		basename,

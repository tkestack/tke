...
const commandDesc = `The platform controller manager is a daemon that embeds the core control loops. In 
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Platform Controller Manager",
		basename,

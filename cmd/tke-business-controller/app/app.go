...
const commandDesc = `The business controller manager is a daemon that embeds the core control loops. In 
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Business Controller Manager",
		basename,

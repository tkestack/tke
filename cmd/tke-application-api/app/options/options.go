...
func NewOptions(serverName string) *Options {
	return &Options{
		Log:               log.NewOptions(),
		SecureServing:     apiserveroptions.NewSecureServingOptions(serverName, 9463),
		Debug:             apiserveroptions.NewDebugOptions(),
		ETCD:              storageoptions.NewETCDStorageOptions("/tke/application"),
...
// Should be called after tke-application-api flags parsed.

...
const commandDesc = `The authz controller manager is a daemon that embeds the core control loops. In
  authz of robotics and automation, a control loop is a non-terminating
  loop that regulates the state of the system. In TKE, a controller is a control
  loop that watches the shared state of the application through the
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Application Controller Manager",
		basename,

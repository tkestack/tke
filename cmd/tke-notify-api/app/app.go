...
const commandDesc = `The Notify API server validates and configures data for the api objects which 
include channel, message, and members. The API Server services REST operations 
...
func NewApp(basename string) *app.App {
	...
	application := app.NewApp("Tencent Kubernetes Engine Notify API Server", basename,

...
const commandDesc = `The Logagent API server validates and configures data for the api objects which
include logagent, configmap, and others. The API Server services REST operations

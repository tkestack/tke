...
3. 点击【新建】按钮。如下图所示： ![新建用户](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/新建用户.png)
4. 在弹出的添加用户窗口填写用户信息。如下图所示： ![添加用户](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/添加用户.png)
...
3. 点击用户列表最右侧的【修改密码】按钮。如下图所示： ![修改密码按钮](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/修改密码按钮.png) 
4. 在弹出的修改密码窗口里输入新的密码并确认。如下图所示： ![修改密码](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/修改密码.png) 
5. 单击【保存】按钮。
...
1. 登录TKEStack
2. 切换至【平台管理】控制台，选择【访问管理】->【用户管理】，查看用户列表。
3. 点击列表中的用户名称。如下图所示： ![用户列表](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/用户列表.png) 
4. 在用户基本信息页面，单击 基本信息 旁的【编辑】按钮。如下图所示： ![编辑用户按钮](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/编辑用户按钮.png) 
5. 在弹出的用户信息框内编辑用户信息。如下图所示： ![用户编辑](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/用户编辑.png) 
6. 单击【保存】按钮。
...
1. 登录 TKEStack。
2. 切换至【平台管理】控制台，选择【访问管理】->【用户管理】，查看用户列表。
3. 点击用户列表最右侧的【删除】按钮。如下图所示： ![删除用户](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/删除用户.png) 
4. 在弹出的确认删除窗口，单击【确认】。
...
4. 在用户组基本信息页面，单击 基本信息 旁的【编辑】按钮。如下图1所示：
  ...
  > 6. 单击【提交】按钮，如上图中的2所示
  > 此界面也可以更改关联用户，如上图中的3所示，点击蓝色【关联用户】按钮后，和 新建用户组 ->添加用户组 中一样的操作来关联用户。这里还可以点击查看【已关联角色】和【已关联策略】
#### 删除用户组
  1. 登录TKEStack
  2. 切换至【平台管理】控制台，选择【访问管理】->【用户组管理】，查看用户组列表。
...
#### 编辑角色基本信息
    ...
    1. 登录TKEStack。
    2. 切换至【平台管理】控制台，选择【访问管理】->【角色管理】，查看角色列表。
    3. 点击列表中的角色名称。如下图1所示：

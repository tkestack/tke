...
4. 在弹出的添加角色窗口填写角色信息。如下图所示：
   ![添加角色](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/添加角色1.png)
   ![添加角色](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/添加角色2.png)
...
3. 点击列表中的角色名称。如下图1所示：
   ![角色列表](../../../../../../../../../Library/Mobile Documents/com~apple~CloudDocs/Typora/images/角色列表.png) 
   
   > 此界面也可以更改关联，如上图2所示，选择相应关联后，和 新建角色->添加角色 中一样的步骤来关联相应操作。
   >
   > 此界面也可以点击最右边的【删除】按钮来删除角色

4. 在用户基本信息页面，单击 基本信息 旁的【编辑】按钮。如下图1所示：
   ![编辑角色按钮](../../../../images/编辑角色按钮.png) 
5. 在弹出的信息框内可以编辑 角色名称 和 角色描述。此时会出现【提交】按钮，点击后可更改用户组基本信息。
6. 此界面也可以更改关联，如上图2所示，选择相应关联后，和 新建角色->添加角色 中一样的操作来关联或解除相应关联。

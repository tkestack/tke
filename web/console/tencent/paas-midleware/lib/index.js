 ...
 */
var translation = {// 使用 `tea scan` 命令扫描词条
};
var zh = {
  ...
  Util.getUserName = function (platform) {
    ...
    if (document.cookie) {
      if (platform === PlatformType.TDCC) {
        try {
          name = (_c = (_b = (_a = Cookie === null || Cookie === void 0 ? void 0 : Cookie.getCookie('nick')) === null || _a === void 0 ? void 0 : _a.split('@')) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.toString();
        } catch (error) {
          name = '';
        }
      }
...
var NumberAndSymbolReg = /^[a-z][0-9a-z-]{1,62}$/; // 校验的相关配置
...
var ServicePlanTypeMap = (_d$1 = {}, _d$1[ServicePlanTypeEnum.System] = {
  ...
  text: i18n.t('自定义'),
  className: 'text-warning'
}, _d$1); // export const getAuthorName =  (platform:string) => {
//   if(platform === PlatformType?.TDCC){
...
var validateFormItemEmpty = function validateFormItemEmpty(field, values) {
  ...
  var validator;
  var fieldValue = values === null || values === void 0 ? void 0 : values[field === null || field === void 0 ? void 0 : field.name]; // 依赖项未启用，校验直接通过
...
})(PlanMustPropMap || (PlanMustPropMap = {})); // 校验的相关配置
...
(function (Backup) {
  ...
  Backup.reduceBackupStrategyJson = function (data) {
    ...
    var minuteStr = '0'; //cron 格式:`* * * * * *`,即:分 时 天 月 周 年(可省略)
...
function generateRouterDecorator(rule) {
  function decorator(target) {
    function onMount() {
      ...
      _this.props.dispatch(startAction(rule)); // Aegis.init();

    }

    function onUnmount() {

      nmcRouter.unuse(rule); //当离开模块的时候，也清楚掉error
...
function PaasHeader(props) {
  ...
  var tabId = reactRedux.useSelector(function (state) {
    var _a;
  ...
  if (platform === (PlatformType === null || PlatformType === void 0 ? void 0 : PlatformType.TDCC)) {
    if ((urlParams === null || urlParams === void 0 ? void 0 : urlParams.sub) === 'create') {
      headerTitle = "\u65B0\u5EFA".concat(servicename !== null && servicename !== void 0 ? servicename : '-').concat((_a = ResourceTypeMap === null || ResourceTypeMap === void 0 ? void 0 : ResourceTypeMap[tabId]) === null || _a === void 0 ? void 0 : _a.title);
    ...
    if (mode === 'create') {
      headerTitle = "\u65B0\u5EFA".concat(servicename !== null && servicename !== void 0 ? servicename : '-').concat((_b = ResourceTypeMap === null || ResourceTypeMap === void 0 ? void 0 : ResourceTypeMap[tabId]) === null || _b === void 0 ? void 0 : _b.title);
    } else if (mode === 'detail') {
      headerTitle = "".concat(servicename, "\u5B9E\u4F8B / ").concat(instancename, "\u5B9E\u4F8B\u8BE6\u60C5");
    } else {
      headerTitle = '中间件列表';
...
function (_super) {
  ...
  TipInfo.prototype.render = function () {
    var _a = this.props,
        ...
        renderStyle = style; // 用于在创建表单当中 展示错误信息
...
function UpdateResource(props) {
  ...
  var reduceCreateServiceResourceDataJson = function reduceCreateServiceResourceDataJson(data) {
    ...
    var _g = data === null || data === void 0 ? void 0 : data.formData,
        ...
        clusterId = _g.clusterId; //拼接中间件实例参数部分属性值
    ...
    var parameters = (_c = (_b = (_a = resourceDetail === null || resourceDetail === void 0 ? void 0 : resourceDetail.object) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.instanceSchema) === null || _c === void 0 ? void 0 : _c.reduce(function (pre, cur) {
      ...
      var _b, _c, _d, _e; // return Object.assign(pre,!!data?.formData?.[cur?.name] ? {[cur?.name]:data?.formData?.[cur?.name] + (data?.formData?.['unitMap']?.[cur?.name] ?? '')} : {});
...
function ServiceDetailHeader(props) {
  ...
  var _handleClickForTagSearch = function _handleClickForTagSearch(tags) {
    ...
    setSearchBoxLength(tags.length); // 如果检测到 tags的长度变化，并且key为 resourceName 去掉了，则清除搜索条件
...
var isI18nSite = teaApp.i18n.site === 2; // zh 为中文，en为英文
...
var reduceYunApiNetworkRequest = function reduceYunApiNetworkRequest(userParams, clusterId) {
  return tslib.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib.__generator(this, function (_g) {
      switch (_g.label) {
        case 0:
          method = userParams.method, url = userParams.url, _a = userParams.userDefinedHeader, userDefinedHeader = _a === void 0 ? {} : _a, _b = userParams.data, apiParams = userParams.apiParams; // 请求tke-apiserver的 cluster的header
          ...
          params = restParams; // 自定义header，只有forwardRequest 这个请求有用
        ...
        case 3:
          error_1 = _g.sent(); //在原来上包了一层data,通过tea.app调用的需要返回error.data
        ...
        case 4:
          return [2
          /*return*/
          , reduceYunApiNetworkResponse(rsp, true)];
      }
    });
  });
};
...
var reduceYunApiNetworkResponse = function reduceYunApiNetworkResponse(response, isApp, interfaceName) {
  ...
  if (isApp) {
    ...
    if (response.code !== undefined) {
      ...
      // 此为V3接口的判断
      var rsp = response.Response; // 如果请求发生了错误，其kind为status
...
var reduceTkeStackNetworkRequest = function reduceTkeStackNetworkRequest(userParams, clusterId, projectId, keyword) {
  return tslib.__awaiter(void 0, void 0, void 0, function () {
    var method, url, _a, userDefinedHeader, _b, data, apiParams, _c, // baseURL = getConsoleAPIAddress(ConsoleModuleAddressEnum.PLATFORM)
    baseURL, rsp, pid, searchParams, params, error_1, uuid_1, response;

    return tslib.__generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          method = userParams.method, url = userParams.url, _a = userParams.userDefinedHeader, userDefinedHeader = _a === void 0 ? {} : _a, _b = userParams.data, data = _b === void 0 ? {} : _b, apiParams = userParams.apiParams, _c = userParams.baseURL, baseURL = _c === void 0 ? GET_CONSOLE_MODULE_BASE_URL : _c; // 请求tke-apiserver的 cluster的header
          ...
          } catch (error) {} // 这里指定为undefined而不是''，因为业务视图下helm仓库的逻辑有时候不需要传业务id，但会因为这里的逻辑从cookie中读取业务id并传到后端，
        ...
        case 3:
          error_1 = _d.sent(); // 如果返回是 401的话，自动登出，此时是鉴权不过，cookies失效了
...
var reduceNetworkRequest = function reduceNetworkRequest(params) {
  ...
  if (platform === PlatformType.TDCC) {
    ...
    return reduceTkeStackNetworkRequest(newParams, ClusterId, ProjectId);
  } else {
    return reduceYunApiNetworkRequest(newParams);
  }
};
...
(function (ExternalCluster) {
  ...
  (function (StatusEnum) {
    ...
    StatusEnum["Waiting"] = "Waiting"; // Initializing = 'Initializing',
    // Confined = 'Confined',
    // Idling = 'Idling',
    // Upgrading = 'Upgrading',

    StatusEnum["Terminating"] = "Terminating"; // Upscaling = 'Upscaling',
...
var tips$2 = seajs.require('tips'); // 获取应用实例列表
    ...
    return tslib.__generator(this, function (_v) {
      switch (_v.label) {
        ...
        case 4:
          ...
          result.recordCount = (_r = (_q = result.records) === null || _q === void 0 ? void 0 : _q.length) !== null && _r !== void 0 ? _r : 0; // 前端分页

          if (paging) {
            pageIndex = (_s = paging === null || paging === void 0 ? void 0 : paging.pageIndex) !== null && _s !== void 0 ? _s : 1;
            pageSize = (_t = paging === null || paging === void 0 ? void 0 : paging.pageSize) !== null && _t !== void 0 ? _t : 20;
            maxPageIndex = Math.ceil(((_u = result.records) === null || _u === void 0 ? void 0 : _u.length) / pageSize);
      ...
      switch (_v.label) {
        ...
        case 2:
          ...
          if ((response === null || response === void 0 ? void 0 : response.code) === 0) {
            ...
            result = {
              // instanceCreateParameterSchema: responseBody?.spec?.instanceCreateParameterSchema?.map(item => ({...item,value:formatPlanSchemaData(item?.type,item?.default),unit:formatPlanSchemaUnit(item,item?.default),
              // })),
              ...
              instanceCreateParameterSchema: (_c = (_b = responseBody === null || responseBody === void 0 ? void 0 : responseBody.spec) === null || _b === void 0 ? void 0 : _b.instanceCreateParameterSchema) === null || _c === void 0 ? void 0 : _c.map(function (item) {
                ...
                var candidates = (_a = item === null || item === void 0 ? void 0 : item.candidates) === null || _a === void 0 ? void 0 : _a.filter(function (candidate) {
                  ...
                  } // else if(platform === PlatformType?.TKESTACK && item?.name ===  'scope'){
      ...
      switch (_f.label) {
        ...
        case 1:
          ...
          try {
            ...
            return [2
            /*return*/
            , operationResult(resource, response)];
          } catch (error) {
            return [2
            /*return*/
            , operationResult(resource, error)];
          }
    ...
    return tslib.__generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [2
          /*return*/
          , operationResult(resource, errorResponse === null || errorResponse === void 0 ? void 0 : errorResponse.error)];
      }
    });
  });
};
    ...
    return tslib.__generator(this, function (_t) {
      switch (_t.label) {
        ...
        case 4:
          ...
          result.recordCount = (_p = result === null || result === void 0 ? void 0 : result.records) === null || _p === void 0 ? void 0 : _p.length; // 前端分页
    ...
    return tslib.__generator(this, function (_j) {
      switch (_j.label) {
        case 0:
          ...
          namespace = SystemNamespace;
          url = "/apis/platform.tkestack.io/v1/clusters/".concat(clusterId, "/proxy?path=/apis/infra.tce.io/v1/namespaces/").concat(namespace, "/").concat((_b = ResourceTypeMap[resourceType]) === null || _b === void 0 ? void 0 : _b.path); //目前query参数查询只支持labelSelector
...
function ServiceDetailTable(props) {
  ...
  var showInstance = function showInstance(item) {
    ...
    var clusterId = Util === null || Util === void 0 ? void 0 : Util.getClusterId(platform, item, route);
    var serviceName = (_a = item === null || item === void 0 ? void 0 : item.spec) === null || _a === void 0 ? void 0 : _a.serviceClass;
    var servicePlan = (_b = item === null || item === void 0 ? void 0 : item.metadata) === null || _b === void 0 ? void 0 : _b.name; // 过滤条件
    ...
    if (selectedTab === ResourceTypeEnum.ServicePlan) {
      cols = [{
        ...
        render: function render(item) {
          ...
          return React__default.createElement(React__default.Fragment, null, React__default.createElement("p", null, (_c = (_b = (_a = item === null || item === void 0 ? void 0 : item.metadata) === null || _a === void 0 ? void 0 : _a.labels) === null || _b === void 0 ? void 0 : _b['ssm.infra.tce.io/creator']) !== null && _c !== void 0 ? _c : '-'));
        }
      }, {
        key: 'operate',
        header: i18n.t('操作'),
      ...
      cols = [{
        ...
        render: function render(item) {
          ...
          var className = ((_b = item === null || item === void 0 ? void 0 : item.status) === null || _b === void 0 ? void 0 : _b.state) === (ServiceInstanceStatusEnum === null || ServiceInstanceStatusEnum === void 0 ? void 0 : ServiceInstanceStatusEnum.Ready) ? 'text-success' : '';
  ...
  var renderOperateButtons = function renderOperateButtons(item) {
    ...
    if (selectedTab === ResourceTypeEnum.ServicePlan) {
      buttons = [{
        ...
        hidden: ((_d = (_c = item === null || item === void 0 ? void 0 : item.metadata) === null || _c === void 0 ? void 0 : _c.labels) === null || _d === void 0 ? void 0 : _d['ssm.infra.tce.io/owner']) === ServicePlanTypeEnum.System,
        disabled: ((_f = (_e = item === null || item === void 0 ? void 0 : item.metadata) === null || _e === void 0 ? void 0 : _e.labels) === null || _f === void 0 ? void 0 : _f['ssm.infra.tce.io/owner']) === ServicePlanTypeEnum.System,
        tooltips: ((_h = (_g = item === null || item === void 0 ? void 0 : item.metadata) === null || _g === void 0 ? void 0 : _g.labels) === null || _h === void 0 ? void 0 : _h['ssm.infra.tce.io/owner']) === ServicePlanTypeEnum.System ? i18n.t('预设规格') : i18n.t('')
      }];
    } else {
      buttons = [{
        text: i18n.t('管理'),
        disabled: !!((_j = item === null || item === void 0 ? void 0 : item.metadata) === null || _j === void 0 ? void 0 : _j.deletionTimestamp),
        handleClick: function handleClick() {
          _navigateDetail(item);
        }
      }, {
        ...
        disabled: !!((_k = item === null || item === void 0 ? void 0 : item.metadata) === null || _k === void 0 ? void 0 : _k.deletionTimestamp),
        tooltips: ''
      }];
    }
...
var detailActions = {
      ...
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_g) {
          switch (_g.label) {
            ...
            case 1:
              resource = _g.sent();
              if (!(resourceType === (ResourceTypeEnum === null || ResourceTypeEnum === void 0 ? void 0 : ResourceTypeEnum.ServiceBinding))) return [3
              /*break*/
              , 3];
              return [4
              /*yield*/
                ...
                instanceSchema: (_f = instanceSchema === null || instanceSchema === void 0 ? void 0 : instanceSchema.filter(function (item) {
                  ...
                  switch (resourceType) {
                    case ResourceTypeEnum.ServiceResource:
                      schemaValue = ((_a = resource === null || resource === void 0 ? void 0 : resource.status) === null || _a === void 0 ? void 0 : _a.metadata) && schemaName || !isEmpty((_b = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _b === void 0 ? void 0 : _b.parameters) ? (_j = (_f = (_e = (_d = (_c = resource === null || resource === void 0 ? void 0 : resource.status) === null || _c === void 0 ? void 0 : _c.metadata) === null || _d === void 0 ? void 0 : _d[schemaName]) === null || _e === void 0 ? void 0 : _e.toString()) !== null && _f !== void 0 ? _f : (_h = (_g = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _g === void 0 ? void 0 : _g.parameters[schemaName]) === null || _h === void 0 ? void 0 : _h.toString()) !== null && _j !== void 0 ? _j : '-' : '';
                      break;

                    case ResourceTypeEnum.ServiceBinding:
                      schemaValue = (secretResource === null || secretResource === void 0 ? void 0 : secretResource.data) && schemaName && ((_k = secretResource === null || secretResource === void 0 ? void 0 : secretResource.data) === null || _k === void 0 ? void 0 : _k[schemaName]) ? (_o = (_m = jsBase64.Base64.atob((_l = secretResource === null || secretResource === void 0 ? void 0 : secretResource.data) === null || _l === void 0 ? void 0 : _l[schemaName])) === null || _m === void 0 ? void 0 : _m.toString()) !== null && _o !== void 0 ? _o : '-' : '';
                      break;

                    default:
                      schemaValue = ((_p = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _p === void 0 ? void 0 : _p.metadata) && schemaName ? (_t = (_s = (_r = (_q = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _q === void 0 ? void 0 : _q.metadata) === null || _r === void 0 ? void 0 : _r[schemaName]) === null || _s === void 0 ? void 0 : _s.toString()) !== null && _t !== void 0 ? _t : '-' : '';
                      break;
                  }
  ...
  instanceResource: ffRedux.createFFListActions({
    ...
    fetcher: function fetcher(query, getState) {
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              if (!(query === null || query === void 0 ? void 0 : query.filter)) return [3
              /*break*/
              , 5];
              if (!(((_a = query === null || query === void 0 ? void 0 : query.filter) === null || _a === void 0 ? void 0 : _a.resourceType) === (ResourceTypeEnum === null || ResourceTypeEnum === void 0 ? void 0 : ResourceTypeEnum.ServiceResource))) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
              , fetchServiceResources(tslib.__assign(tslib.__assign({}, query === null || query === void 0 ? void 0 : query.filter), {
            ...
            case 2:
              return [4
              /*yield*/
              , fetchInstanceResources(tslib.__assign(tslib.__assign({}, query === null || query === void 0 ? void 0 : query.filter), {
                paging: query === null || query === void 0 ? void 0 : query.paging
              }))];
    ...
    onFinish: function onFinish(record, dispatch, getState) {
      ...
      var instanceResource = getState().detail.instanceResource; //判断是否开启轮训
      ...
      if ((_e = record === null || record === void 0 ? void 0 : record.data) === null || _e === void 0 ? void 0 : _e.recordCount) {
        var _g = (_f = instanceResource === null || instanceResource === void 0 ? void 0 : instanceResource.query) === null || _f === void 0 ? void 0 : _f.filter,
            ...
            serviceName = _g.serviceName; // 查看实例关联的规格资源
        ...
        return tslib.__generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              ...
              if (!backupStrategyEdit) return [3
              /*break*/
              , 2];
              ...
              return [4
              /*yield*/
              , Backup.getValidatorModel(backupStrategyEdit)];
  ...
  openInstanceConsole: ffRedux.generateWorkflowActionCreator({
    ...
    after: (_a$5 = {}, _a$5[ffRedux.OperationTrigger.Done] = function (dispatch, getState) {
        ...
        return tslib.__generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , fetchNamespaces(query === null || query === void 0 ? void 0 : query.filter)];
...
var createActions = {
  ...
  updateResource: ffRedux.generateWorkflowActionCreator({
    ...
    after: (_b$5 = {}, _b$5[ffRedux.OperationTrigger.Done] = function (dispatch, getState) {
      var _a, _b, _c;
        ...
        return tslib.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , Promise.all([createServiceResource(instance, params).then(function (response) {
                return response;
              }, function (error) {
                return error;
            ...
            case 1:
              ...
              if (!(error === null || error === void 0 ? void 0 : error.length)) {
                return [2
                /*return*/
                , operationResult(targets, [], response)];
              } else {
                return [2
                /*return*/
                , operationResult(targets, (_b = error === null || error === void 0 ? void 0 : error[0]) === null || _b === void 0 ? void 0 : _b.error)];
              }
          }
        });
      });
...
var listActions = {
        ...
        return tslib.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              if (!(platform && clusterId && regionId && serviceName)) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
  ...
  externalClusters: ffRedux.createFFListActions({
    ...
    fetcher: function fetcher(query, getState) {
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        var _a, regionId, _b, _c, regional, platform, result;
        ...
        return tslib.__generator(this, function (_g) {
          switch (_g.label) {
            case 0:
              ...
              platform = ((_d = getState()) === null || _d === void 0 ? void 0 : _d.base).platform;
              if (!(platform && regionId)) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
        ...
        return tslib.__generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              if (!(platform && clusterId && serviceName && resourceType)) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
  ...
  services: ffRedux.createFFListActions({
        ...
        return tslib.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              platform = ((_b = getState()) === null || _b === void 0 ? void 0 : _b.base).platform;
              if (!(platform && clusterId)) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
    ...
    onSelect: function onSelect(record, dispatch, getState) {
      ...
      var clusterId = (_c = route === null || route === void 0 ? void 0 : route.queries) === null || _c === void 0 ? void 0 : _c.clusterid; // 查询resourceSchema配置
        ...
        return tslib.__generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , fetchServiceResources(query === null || query === void 0 ? void 0 : query.filter)];
    ...
    return function (dispatch, getState) {
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_c) {
          ...
          _a = getState().base, route = _a.route, platform = _a.platform; // tdcc首先拉取hub集群,然后拉取已开通的服务列表;tkeStack同时拉取目标集群和拉取已开通的服务列表
        ...
        return tslib.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , fetchHubCluster(query === null || query === void 0 ? void 0 : query.filter)];
    ...
    fetcher: function fetcher(query, getState) {
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              if (!(((_a = query === null || query === void 0 ? void 0 : query.filter) === null || _a === void 0 ? void 0 : _a.platform) === PlatformType.TDCC)) return [3
              /*break*/
              , 1];
              response = {
                name: Util === null || Util === void 0 ? void 0 : Util.getUserName((_b = query === null || query === void 0 ? void 0 : query.filter) === null || _b === void 0 ? void 0 : _b.platform)
              };
              return [3
              /*break*/
              , 3];
            ...
            case 1:
              return [4
              /*yield*/
              , fetchUserInfo(query === null || query === void 0 ? void 0 : query.filter)];
...
function configStore() {
  var store = createStore(generateResetableReducer(RootReducer)); // hot reloading
...
function ServiceInstanceCreatePanel(props) {
  ...
  var actions = props.actions,
      ...
      platform = _g.platform,
      route = _g.route,
      hubCluster = _g.hubCluster,
      isI18n = _g.isI18n,
      userInfo = _g.userInfo,
      regionId = _g.regionId,
      _h = props.list,
      services = _h.services,
      servicePlans = _h.servicePlans,
      createResourceWorkflow = _h.createResourceWorkflow,
      createServiceInstanceWorkflow = _h.createServiceInstanceWorkflow,
      externalClusters = _h.externalClusters;
  var servicename = (route === null || route === void 0 ? void 0 : route.queries).servicename;
  ...
  var isLoadingSchema = ((_a = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _a === void 0 ? void 0 : _a.fetchState) === ffRedux.FetchState.Fetching || !((_b = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _b === void 0 ? void 0 : _b.fetched);
  React.useEffect(function () {
    var _a;
  ...
  }, [(_c = actions === null || actions === void 0 ? void 0 : actions.list) === null || _c === void 0 ? void 0 : _c.externalClusters, platform, services === null || services === void 0 ? void 0 : services.selection]);
  var loadSchemaFailed = React__default === null || React__default === void 0 ? void 0 : React__default.useMemo(function () {
    var _a, _b, _c, _d;

    return ((_a = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _a === void 0 ? void 0 : _a['isSetParams']) && ((_b = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _b === void 0 ? void 0 : _b.fetched) && (((_c = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _c === void 0 ? void 0 : _c.error) || ((_d = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _d === void 0 ? void 0 : _d.fetchState) === ffRedux.FetchState.Failed);
  }, [(_d = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _d === void 0 ? void 0 : _d['isSetParams'], servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object]); // 由于vendor在目标集群上开启为异步操作，因此若vendor在集群上执行了开启且schema加载resource not found,则认为vendor正在开启中
  ...
  var showVisitForbidden = React__default === null || React__default === void 0 ? void 0 : React__default.useMemo(function () {
    var _a, _b, _c, _d, _e, _f, _g;

    return ((_b = (_a = services === null || services === void 0 ? void 0 : services.selection) === null || _a === void 0 ? void 0 : _a.clusters) === null || _b === void 0 ? void 0 : _b.includes((_c = externalClusters === null || externalClusters === void 0 ? void 0 : externalClusters.selection) === null || _c === void 0 ? void 0 : _c.clusterId)) && ((_d = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _d === void 0 ? void 0 : _d.fetched) && ((_e = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _e === void 0 ? void 0 : _e.error) && ((_g = (_f = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _f === void 0 ? void 0 : _f.error) === null || _g === void 0 ? void 0 : _g.message.includes('forbidden'));
  }, [servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object, services === null || services === void 0 ? void 0 : services.selection, externalClusters === null || externalClusters === void 0 ? void 0 : externalClusters.selection]);
  var createWorkflow = ((_e = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _e === void 0 ? void 0 : _e.timeBackup) ? createServiceInstanceWorkflow : createResourceWorkflow;
  ...
  var reduceCreateServiceResourceDataJson = function reduceCreateServiceResourceDataJson(data) {
    ...
    var _l = data === null || data === void 0 ? void 0 : data.formData,
        ...
        clusterId = _l.clusterId; //拼接中间件实例参数部分属性值
    ...
    var json = {
      ...
      spec: {
        ...
        externalID: DefaultNamespace + '-' + instanceName // ...backupParams,
  ...
  var _submit = function _submit() {
    ...
    if ((formData === null || formData === void 0 ? void 0 : formData['isSetParams']) && !((_c = (_b = (_a = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.instanceCreateParameterSchema) === null || _c === void 0 ? void 0 : _c.length)) {
    ...
    if (_validateInstance(servicesInstanceEdit, (_e = (_d = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.instanceCreateParameterSchema)) {
      if (!(formData === null || formData === void 0 ? void 0 : formData.timeBackup)) {
        var params = {
          platform: platform,
          regionId: HubCluster === null || HubCluster === void 0 ? void 0 : HubCluster.DefaultRegion,
        ...
        var backupStrategyParams = {
          ...
          jsonData: Backup.reduceBackupStrategyJson({
            ...
            instanceName: formData === null || formData === void 0 ? void 0 : formData.instanceName,
            serviceName: ((_f = services === null || services === void 0 ? void 0 : services.selection) === null || _f === void 0 ? void 0 : _f.name) || ((_g = route === null || route === void 0 ? void 0 : route.queries) === null || _g === void 0 ? void 0 : _g.servicename)
          }),
  ...
  var renderContent = function renderContent(data) {
    ...
    return React__default.createElement(ffComponent.FormPanel, null, React__default.createElement(ffComponent.FormPanel.Item, {
      ...
      validator: (_m = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _m === void 0 ? void 0 : _m['instanceName'],
      input: {
        value: (_o = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _o === void 0 ? void 0 : _o['instanceName'],
        onChange: function onChange(e) {
          var _a;
      ...
      validator: (_p = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _p === void 0 ? void 0 : _p['plan'],
      ...
      model: servicePlans,
      action: (_u = actions === null || actions === void 0 ? void 0 : actions.list) === null || _u === void 0 ? void 0 : _u.servicePlans,
      ...
      value: (_w = (_v = servicePlans === null || servicePlans === void 0 ? void 0 : servicePlans.selection) === null || _v === void 0 ? void 0 : _v.metadata) === null || _w === void 0 ? void 0 : _w.name
    })), showBackUpOperation && React__default.createElement(ffComponent.FormPanel.Item, {
      label: i18n.t('定时备份'),
      required: false,
      validator: (_x = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _x === void 0 ? void 0 : _x['timeBackup'],
      message: ((_z = (_y = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _y === void 0 ? void 0 : _y['backupDate']) === null || _z === void 0 ? void 0 : _z.status) === 2 || ((_1 = (_0 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _0 === void 0 ? void 0 : _0['backupTime']) === null || _1 === void 0 ? void 0 : _1.status) === 2 ? React__default.createElement(teaComponent.Text, {
        className: 'text-danger'
      }, i18n.t('{{message}}', {
        message: (_3 = (_2 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _2 === void 0 ? void 0 : _2['backupDate']) === null || _3 === void 0 ? void 0 : _3.message
      })) : null
    }, React__default.createElement(teaComponent.Switch, {
      value: (_4 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _4 === void 0 ? void 0 : _4['timeBackup'],
      onChange: function onChange(value) {
        return tslib.__awaiter(_this, void 0, void 0, function () {
          var cosResource;
    ...
    })), showBackUpOperation && ((_5 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _5 === void 0 ? void 0 : _5['timeBackup']) ? React__default.createElement(React__default.Fragment, null, React__default.createElement(ffComponent.FormPanel.Item, {
      label: i18n.t('备份日期')
    }, React__default.createElement(teaComponent.Checkbox.Group, {
      value: (_6 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _6 === void 0 ? void 0 : _6.backupDate,
      onChange: function onChange(value) {
        var _a;

        (_a = actions === null || actions === void 0 ? void 0 : actions.create) === null || _a === void 0 ? void 0 : _a.updateInstance('backupDate', value);
      }
    }, (_7 = Backup === null || Backup === void 0 ? void 0 : Backup.weekConfig) === null || _7 === void 0 ? void 0 : _7.map(function (item) {
      ...
      value: (_8 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _8 === void 0 ? void 0 : _8.backupTime,
      onChange: function onChange(value) {
        var _a;

        (_a = actions === null || actions === void 0 ? void 0 : actions.create) === null || _a === void 0 ? void 0 : _a.updateInstance('backupTime', value);
      }
    }, (_9 = Backup === null || Backup === void 0 ? void 0 : Backup.hourConfig) === null || _9 === void 0 ? void 0 : _9.map(function (item) {
      return React__default.createElement(teaComponent.Checkbox, {
        key: item === null || item === void 0 ? void 0 : item.value,
        name: item === null || item === void 0 ? void 0 : item.value,
        className: 'tea-mb-2n',
      ...
      value: (_10 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _10 === void 0 ? void 0 : _10.backupReserveDay,
      onChange: function onChange(value) {
        var _a;
      ...
      label: i18n.t('设置实例参数'),
      required: false,
      validator: (_11 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _11 === void 0 ? void 0 : _11['isSetParams']
    }, React__default.createElement(teaComponent.Switch, {
      value: (_12 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _12 === void 0 ? void 0 : _12['isSetParams'],
      onChange: function onChange(e) {
        var _a;

        (_a = actions === null || actions === void 0 ? void 0 : actions.create) === null || _a === void 0 ? void 0 : _a.updateInstance('isSetParams', e);
      }
    })), isLoadingSchema && React__default.createElement(LoadingPanel, null), !isLoadingSchema && !openingVendor && loadSchemaFailed && React__default.createElement(RetryPanel, {
      style: {
        minWidth: 150,
        width: 150
      },
      loadingText: i18n.t('Schema加载失败'),
      action: (_14 = (_13 = actions === null || actions === void 0 ? void 0 : actions.list) === null || _13 === void 0 ? void 0 : _13.resourceSchemas) === null || _14 === void 0 ? void 0 : _14.fetch
    }), !isLoadingSchema && openingVendor && React__default.createElement(RetryPanel, {
      style: {
        minWidth: 170,
        width: 170
      },
      loadingText: i18n.t('{{text}}', {
        text: "".concat((_15 = services === null || services === void 0 ? void 0 : services.selection) === null || _15 === void 0 ? void 0 : _15.name, "\u5F00\u542F\u4E2D...")
      }),
      loadingTextTheme: 'text',
      action: (_17 = (_16 = actions === null || actions === void 0 ? void 0 : actions.list) === null || _16 === void 0 ? void 0 : _16.resourceSchemas) === null || _17 === void 0 ? void 0 : _17.fetch
    }), !isLoadingSchema && !loadSchemaFailed && !openingVendor && React__default.createElement(React__default.Fragment, null, versionFields === null || versionFields === void 0 ? void 0 : versionFields.map(function (item) {
      var _a, _b, _c, _d, _e;
    ...
    }), ((_18 = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _18 === void 0 ? void 0 : _18['isSetParams']) && (instanceParamsFields === null || instanceParamsFields === void 0 ? void 0 : instanceParamsFields.map(function (item, index) {
      var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
...
function ServicePlanCreatePanel(props) {
  ...
  var _j = React.useState({}),
      planSchemaUnitMap = _j[0],
      setPlanSchemaUnitMap = _j[1];
  ...
  var isLoading = ((_b = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _b === void 0 ? void 0 : _b.fetchState) === ffRedux.FetchState.Fetching || !((_c = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _c === void 0 ? void 0 : _c.fetched);
  var loadSchemaFailed = ((_d = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _d === void 0 ? void 0 : _d.error) || ((_e = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _e === void 0 ? void 0 : _e.fetchState) === ffRedux.FetchState.Failed || (servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object.data) === undefined;
  var openingVendor = React__default === null || React__default === void 0 ? void 0 : React__default.useMemo(function () {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
  ...
  var reduceCreateServiceResourceDataJson = function reduceCreateServiceResourceDataJson(data) {
    ...
    var _j = data === null || data === void 0 ? void 0 : data.formData,
        ...
        clusterId = _j.clusterId; //拼接中间件实例参数部分属性值
  ...
  var _submit = function _submit() {
    ...
    if (!((_c = (_b = (_a = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.planSchema) === null || _c === void 0 ? void 0 : _c.length)) {
      teaComponent.message === null || teaComponent.message === void 0 ? void 0 : teaComponent.message.warning({
        content: i18n.t('Schema数据异常,请刷新重试')
      });
      return;
    ...
    var formData = servicesInstanceEdit.formData;
    actions.create.validatePlan((_e = (_d = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.planSchema);

    if (_validatePlan(servicesInstanceEdit, (_g = (_f = servicesInstance === null || servicesInstance === void 0 ? void 0 : servicesInstance.object) === null || _f === void 0 ? void 0 : _f.data) === null || _g === void 0 ? void 0 : _g.planSchema)) {
      var params = {
        platform: platform,
        regionId: HubCluster === null || HubCluster === void 0 ? void 0 : HubCluster.DefaultRegion,
        clusterId: formData === null || formData === void 0 ? void 0 : formData.clusterId,
  ...
  var renderContent = function renderContent(data) {
    ...
    return React__default.createElement(ffComponent.FormPanel, null, React__default.createElement(ffComponent.FormPanel.Item, {
      ...
      validator: (_g = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _g === void 0 ? void 0 : _g['instanceName'],
      input: {
        value: (_h = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _h === void 0 ? void 0 : _h['instanceName'],
        onChange: function onChange(e) {
          var _a;
      ...
      label: i18n.t('描述'),
      validator: (_j = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.validator) === null || _j === void 0 ? void 0 : _j['description'],
      input: {
        value: (_k = servicesInstanceEdit === null || servicesInstanceEdit === void 0 ? void 0 : servicesInstanceEdit.formData) === null || _k === void 0 ? void 0 : _k['description'],
        onChange: function onChange(e) {
          var _a;
    ...
    }), isLoading && React__default.createElement(LoadingPanel, null), !isLoading && !openingVendor && loadSchemaFailed && React__default.createElement(RetryPanel, {
      style: {
        minWidth: 150
      },
      loadingText: i18n.t('Schema加载失败'),
      action: (_m = (_l = actions === null || actions === void 0 ? void 0 : actions.list) === null || _l === void 0 ? void 0 : _l.resourceSchemas) === null || _m === void 0 ? void 0 : _m.fetch
    }), !isLoading && openingVendor && React__default.createElement(RetryPanel, {
      style: {
        minWidth: 170
      },
      loadingText: i18n.t('{{text}}', {
        text: "".concat((_o = services === null || services === void 0 ? void 0 : services.selection) === null || _o === void 0 ? void 0 : _o.name, "\u5F00\u542F\u4E2D...")
      }),
      loadingTextTheme: 'text',
      action: (_q = (_p = actions === null || actions === void 0 ? void 0 : actions.list) === null || _p === void 0 ? void 0 : _p.resourceSchemas) === null || _q === void 0 ? void 0 : _q.fetch
    }), !isLoading && !loadSchemaFailed && !openingVendor && (instanceParamsFields === null || instanceParamsFields === void 0 ? void 0 : instanceParamsFields.map(function (item, index) {
      var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
...
function ServiceCreate(props) {
  var selectedTab = props.base.selectedTab;
...
function InstanceBaseDetail(props) {
  ...
  var _7 = props.base,
      platform = _7.platform,
      route = _7.route,
      regionId = _7.regionId,
      servicesInstance = props.list.servicesInstance,
      _8 = props.detail,
      resourceDetail = _8.resourceDetail,
      openConsoleWorkflow = _8.openConsoleWorkflow,
      actions = props.actions;
  ...
  var rsIps = getRsIps((_q = resource === null || resource === void 0 ? void 0 : resource.status) === null || _q === void 0 ? void 0 : _q.deploy); // const _confirm  = (isOpen:boolean) => {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(teaComponent.Row, {
    ...
    className: 'tea-mr-2n',
    overflow: true
  }, i18n.t('名称:')), React__default.createElement(teaComponent.Text, null, (_s = (_r = resource === null || resource === void 0 ? void 0 : resource.metadata) === null || _r === void 0 ? void 0 : _r.name) !== null && _s !== void 0 ? _s : '-')), React__default.createElement(teaComponent.Col, {
    span: 6
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n'
  }, i18n.t('ID:')), React__default.createElement(teaComponent.Text, null, (_u = (_t = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _t === void 0 ? void 0 : _t.externalID) !== null && _u !== void 0 ? _u : '-')), React__default.createElement(teaComponent.Col, {
    span: 6
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n'
  }, i18n.t('版本:')), React__default.createElement(teaComponent.Text, null, (_x = (_w = (_v = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _v === void 0 ? void 0 : _v.parameters) === null || _w === void 0 ? void 0 : _w.version) !== null && _x !== void 0 ? _x : '-')), React__default.createElement(teaComponent.Col, {
    span: 6
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n'
  ...
  }, (_z = (_y = resource === null || resource === void 0 ? void 0 : resource.spec) === null || _y === void 0 ? void 0 : _y.servicePlan) !== null && _z !== void 0 ? _z : '-'))), React__default.createElement(teaComponent.Row, null, React__default.createElement(teaComponent.Col, {
    span: 6
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n',
    overflow: true
    ...
    overflow: true,
    tooltip: true
  }, (_2 = (_1 = (_0 = resource === null || resource === void 0 ? void 0 : resource.metadata) === null || _0 === void 0 ? void 0 : _0.labels) === null || _1 === void 0 ? void 0 : _1['ssm.infra.tce.io/creator']) !== null && _2 !== void 0 ? _2 : '-')), React__default.createElement(teaComponent.Col, {
    span: 6
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n'
    ...
    overflow: true,
    tooltip: true
  }, (_4 = (_3 = resource === null || resource === void 0 ? void 0 : resource.metadata) === null || _3 === void 0 ? void 0 : _3.namespace) !== null && _4 !== void 0 ? _4 : '-')), React__default.createElement(teaComponent.Col, {
    span: 12
  }, React__default.createElement(teaComponent.Text, {
    className: 'tea-mr-2n'
  }, i18n.t('创建时间:')), React__default.createElement(teaComponent.Text, null, ((_5 = resource === null || resource === void 0 ? void 0 : resource.metadata) === null || _5 === void 0 ? void 0 : _5.creationTimestamp) ? dateFormatter(new Date((_6 = resource === null || resource === void 0 ? void 0 : resource.metadata) === null || _6 === void 0 ? void 0 : _6.creationTimestamp), 'YYYY-MM-DD HH:mm:ss') : '-'))))), React__default.createElement(ffComponent.FormPanel, {
    title: '服务入口',
    style: {
      width: '100%'
    }
...
function CreateServiceBindingDialog(props) {
  ...
  var reduceServiceBindingJson = function reduceServiceBindingJson(data) {
    ...
    var _g = data === null || data === void 0 ? void 0 : data.formData,
        name = _g.name,
        namespace = _g.namespace; //拼接中间件实例参数部分属性值
      ...
      return tslib.__generator(this, function (_l) {
        switch (_l.label) {
          case 0:
            ...
            } // if(services?.selection?.name === 'rabbitmq' && 
            //    serviceResources?.list?.data?.records?.find(item => item?.metadata?.name === route?.queries?.instancename)?.spec?.parameters?.adminUser === serviceBindingEdit?.formData?.['user']
            // ){
            //   message?.warning({content:t('用户名不能和实例管理用户名相同')});
            //   return;
            // }
            ...
            return [4
            /*yield*/
            , (_b = actions === null || actions === void 0 ? void 0 : actions.detail) === null || _b === void 0 ? void 0 : _b.validateAllServiceBinding()];
      ...
      return tslib.__generator(this, function (_r) {
        switch (_r.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , (_b = actions === null || actions === void 0 ? void 0 : actions.detail) === null || _b === void 0 ? void 0 : _b.validateAll()];

...
export const C_ApiKeyDescription = 'C_ApiKeyDescription';
export const C_ApiKeyExpires = 'C_ApiKeyExpires';
export const UpdateApiKeyCreation = 'UpdateApiKeyCreation';
export const DeleteApiKey = 'DeleteApiKey';
export const ToggleKeyStatus = 'ToggleKeyStatus';

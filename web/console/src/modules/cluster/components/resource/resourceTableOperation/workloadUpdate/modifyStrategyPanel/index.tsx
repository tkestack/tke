...
import { Breadcrumb, Button, Form, InputNumber, Radio, Select } from 'tea-component';
import {
...
export const ModifyStrategyPanel = ({ kind }: IModifyStrategyPanelProps) => {
    ...
    <TeaFormLayout
      title={
        <Breadcrumb>
          ...
          <Breadcrumb.Item>设置更新策略</Breadcrumb.Item>
        </Breadcrumb>
      }
      footer={
        <>
      ...
      <>
        <Form>
          ...
          <Form.Item label={t('资源名称')}>
            <Form.Text>{resourceId}</Form.Text>
          </Form.Item>
        </Form>

...
// Utility functions for the Audit's auditconfig API group

// NewSchemeAndCodecs is a utility function that returns a Scheme and CodecFactory
// that understand the types in the auditconfig API group.
func NewSchemeAndCodecs() (*runtime.Scheme, *serializer.CodecFactory, error) {
	scheme := runtime.NewScheme()
	if err := auditconfig.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}
	if err := auditconfigv1.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}

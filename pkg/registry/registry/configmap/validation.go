...
func ValidateConfigMap(configmap *registry.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *registry.ConfigMap, old *registry.ConfigMap) field.ErrorList {

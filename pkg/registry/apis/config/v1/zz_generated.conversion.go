...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EtcdStorage)(nil), (*config.EtcdStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EtcdStorage_To_config_EtcdStorage(a.(*EtcdStorage), b.(*config.EtcdStorage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EtcdStorage)(nil), (*EtcdStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EtcdStorage_To_v1_EtcdStorage(a.(*config.EtcdStorage), b.(*EtcdStorage), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*Maintenance)(nil), (*config.Maintenance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_Maintenance_To_config_Maintenance(a.(*Maintenance), b.(*config.Maintenance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.Maintenance)(nil), (*Maintenance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_Maintenance_To_v1_Maintenance(a.(*config.Maintenance), b.(*Maintenance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ReadOnly)(nil), (*config.ReadOnly)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ReadOnly_To_config_ReadOnly(a.(*ReadOnly), b.(*config.ReadOnly), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ReadOnly)(nil), (*ReadOnly)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ReadOnly_To_v1_ReadOnly(a.(*config.ReadOnly), b.(*ReadOnly), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_EtcdStorage_To_config_EtcdStorage(in *EtcdStorage, out *config.EtcdStorage, s conversion.Scope) error {
...
func Convert_v1_EtcdStorage_To_config_EtcdStorage(in *EtcdStorage, out *config.EtcdStorage, s conversion.Scope) error {
	return autoConvert_v1_EtcdStorage_To_config_EtcdStorage(in, out, s)
}

func autoConvert_config_EtcdStorage_To_v1_EtcdStorage(in *config.EtcdStorage, out *EtcdStorage, s conversion.Scope) error {
	out.CAFile = in.CAFile
	out.CertFile = in.CertFile
	out.KeyFile = in.KeyFile
	out.EndPoints = *(*[]string)(unsafe.Pointer(&in.EndPoints))
...
func Convert_config_EtcdStorage_To_v1_EtcdStorage(in *config.EtcdStorage, out *EtcdStorage, s conversion.Scope) error {
	return autoConvert_config_EtcdStorage_To_v1_EtcdStorage(in, out, s)
}
...
func autoConvert_v1_Maintenance_To_config_Maintenance(in *Maintenance, out *config.Maintenance, s conversion.Scope) error {
	if err := Convert_v1_ReadOnly_To_config_ReadOnly(&in.ReadOnly, &out.ReadOnly, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_Maintenance_To_config_Maintenance is an autogenerated conversion function.
func Convert_v1_Maintenance_To_config_Maintenance(in *Maintenance, out *config.Maintenance, s conversion.Scope) error {
	return autoConvert_v1_Maintenance_To_config_Maintenance(in, out, s)
}

func autoConvert_config_Maintenance_To_v1_Maintenance(in *config.Maintenance, out *Maintenance, s conversion.Scope) error {
	if err := Convert_config_ReadOnly_To_v1_ReadOnly(&in.ReadOnly, &out.ReadOnly, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_Maintenance_To_v1_Maintenance is an autogenerated conversion function.
func Convert_config_Maintenance_To_v1_Maintenance(in *config.Maintenance, out *Maintenance, s conversion.Scope) error {
	return autoConvert_config_Maintenance_To_v1_Maintenance(in, out, s)
}

func autoConvert_v1_ReadOnly_To_config_ReadOnly(in *ReadOnly, out *config.ReadOnly, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1_ReadOnly_To_config_ReadOnly is an autogenerated conversion function.
func Convert_v1_ReadOnly_To_config_ReadOnly(in *ReadOnly, out *config.ReadOnly, s conversion.Scope) error {
	return autoConvert_v1_ReadOnly_To_config_ReadOnly(in, out, s)
}

func autoConvert_config_ReadOnly_To_v1_ReadOnly(in *config.ReadOnly, out *ReadOnly, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_config_ReadOnly_To_v1_ReadOnly is an autogenerated conversion function.
func Convert_config_ReadOnly_To_v1_ReadOnly(in *config.ReadOnly, out *ReadOnly, s conversion.Scope) error {
	return autoConvert_config_ReadOnly_To_v1_ReadOnly(in, out, s)
}
...
func autoConvert_v1_Storage_To_config_Storage(in *Storage, out *config.Storage, s conversion.Scope) error {
	...
	out.Etcd = (*config.EtcdStorage)(unsafe.Pointer(in.Etcd))
	out.Delete = (*config.Delete)(unsafe.Pointer(in.Delete))
	out.Maintenance = (*config.Maintenance)(unsafe.Pointer(in.Maintenance))
	return nil
}
...
func autoConvert_config_Storage_To_v1_Storage(in *config.Storage, out *Storage, s conversion.Scope) error {
	...
	out.Etcd = (*EtcdStorage)(unsafe.Pointer(in.Etcd))

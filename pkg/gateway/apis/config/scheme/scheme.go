...
// Utility functions for the Gateway's gatewayconfig API group

// NewSchemeAndCodecs is a utility function that returns a Scheme and CodecFactory
// that understand the types in the gatewayconfig API group.
func NewSchemeAndCodecs() (*runtime.Scheme, *serializer.CodecFactory, error) {
	scheme := runtime.NewScheme()
	if err := gatewayconfig.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}
	if err := gatewayconfigv1.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}

...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ConsoleConfig)(nil), (*config.ConsoleConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ConsoleConfig_To_config_ConsoleConfig(a.(*ConsoleConfig), b.(*config.ConsoleConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ConsoleConfig)(nil), (*ConsoleConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ConsoleConfig_To_v1_ConsoleConfig(a.(*config.ConsoleConfig), b.(*ConsoleConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ConsoleConfig_To_config_ConsoleConfig(in *ConsoleConfig, out *config.ConsoleConfig, s conversion.Scope) error {
	out.Title = in.Title
	out.LogoDir = in.LogoDir
	out.CustomConfig = in.CustomConfig
	return nil
}

// Convert_v1_ConsoleConfig_To_config_ConsoleConfig is an autogenerated conversion function.
func Convert_v1_ConsoleConfig_To_config_ConsoleConfig(in *ConsoleConfig, out *config.ConsoleConfig, s conversion.Scope) error {
	return autoConvert_v1_ConsoleConfig_To_config_ConsoleConfig(in, out, s)
}

func autoConvert_config_ConsoleConfig_To_v1_ConsoleConfig(in *config.ConsoleConfig, out *ConsoleConfig, s conversion.Scope) error {
	out.Title = in.Title
	out.LogoDir = in.LogoDir
	out.CustomConfig = in.CustomConfig
	return nil
...
// Convert_config_ConsoleConfig_To_v1_ConsoleConfig is an autogenerated conversion function.
func Convert_config_ConsoleConfig_To_v1_ConsoleConfig(in *config.ConsoleConfig, out *ConsoleConfig, s conversion.Scope) error {
	return autoConvert_config_ConsoleConfig_To_v1_ConsoleConfig(in, out, s)
}
...
func autoConvert_v1_GatewayConfiguration_To_config_GatewayConfiguration(in *GatewayConfiguration, out *config.GatewayConfiguration, s conversion.Scope) error {
	...
	out.ConsoleConfig = (*config.ConsoleConfig)(unsafe.Pointer(in.ConsoleConfig))
	return nil
}
...
func autoConvert_config_GatewayConfiguration_To_v1_GatewayConfiguration(in *config.GatewayConfiguration, out *GatewayConfiguration, s conversion.Scope) error {
	...
	out.ConsoleConfig = (*ConsoleConfig)(unsafe.Pointer(in.ConsoleConfig))
	return nil
}

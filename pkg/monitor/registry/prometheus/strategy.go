...
func (Strategy) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	if prom.Status.Phase == "" {
		prom.Status.Phase = monitor.AddonPhaseInitializing
	}
}
...
func (Strategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	_, tenantID := authentication.UsernameAndTenantID(ctx)
	if len(tenantID) != 0 {
		oldProm := old.(*monitor.Prometheus)
		prom, _ := obj.(*monitor.Prometheus)
...
func (Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidatePrometheus(obj.(*monitor.Prometheus))
}
...
func (Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidatePrometheusUpdate(obj.(*monitor.Prometheus), old.(*monitor.Prometheus))
}
...
func ToSelectableFields(prom *monitor.Prometheus) fields.Set {
...
func (StatusStrategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newProm := obj.(*monitor.Prometheus)
	oldProm := old.(*monitor.Prometheus)

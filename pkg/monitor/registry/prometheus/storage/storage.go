...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter, privilegedUsername string) *Storage {
	...
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &monitor.Prometheus{} },
		NewListFunc:              func() runtime.Object { return &monitor.PrometheusList{} },
		DefaultQualifiedResource: monitor.Resource("prometheuses"),
...
// REST implements a RESTStorage for prometheus against etcd.
type REST struct {
	*registry.Store
...
// StatusREST implements the REST endpoint for changing the status of a prometheus.

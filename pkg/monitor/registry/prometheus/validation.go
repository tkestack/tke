...
func ValidatePrometheus(prom *monitor.Prometheus) field.ErrorList {
...
func ValidatePrometheusUpdate(prom *monitor.Prometheus, old *monitor.Prometheus) field.ErrorList {

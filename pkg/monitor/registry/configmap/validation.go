...
func ValidateConfigMap(configmap *monitor.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *monitor.ConfigMap, old *monitor.ConfigMap) field.ErrorList {

...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ThanosStorage)(nil), (*config.ThanosStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ThanosStorage_To_config_ThanosStorage(a.(*ThanosStorage), b.(*config.ThanosStorage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ThanosStorage)(nil), (*ThanosStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ThanosStorage_To_v1_ThanosStorage(a.(*config.ThanosStorage), b.(*ThanosStorage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ThanosStorageServer)(nil), (*config.ThanosStorageServer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ThanosStorageServer_To_config_ThanosStorageServer(a.(*ThanosStorageServer), b.(*config.ThanosStorageServer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ThanosStorageServer)(nil), (*ThanosStorageServer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ThanosStorageServer_To_v1_ThanosStorageServer(a.(*config.ThanosStorageServer), b.(*ThanosStorageServer), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1_Storage_To_config_Storage(in *Storage, out *config.Storage, s conversion.Scope) error {
	out.Thanos = (*config.ThanosStorage)(unsafe.Pointer(in.Thanos))
...
func autoConvert_config_Storage_To_v1_Storage(in *config.Storage, out *Storage, s conversion.Scope) error {
	out.Thanos = (*ThanosStorage)(unsafe.Pointer(in.Thanos))
...
func autoConvert_v1_ThanosStorage_To_config_ThanosStorage(in *ThanosStorage, out *config.ThanosStorage, s conversion.Scope) error {
	out.Servers = *(*[]config.ThanosStorageServer)(unsafe.Pointer(&in.Servers))
	return nil
}
...
func Convert_v1_ThanosStorage_To_config_ThanosStorage(in *ThanosStorage, out *config.ThanosStorage, s conversion.Scope) error {
	return autoConvert_v1_ThanosStorage_To_config_ThanosStorage(in, out, s)
}

func autoConvert_config_ThanosStorage_To_v1_ThanosStorage(in *config.ThanosStorage, out *ThanosStorage, s conversion.Scope) error {
	out.Servers = *(*[]ThanosStorageServer)(unsafe.Pointer(&in.Servers))
	return nil
}
...
func Convert_config_ThanosStorage_To_v1_ThanosStorage(in *config.ThanosStorage, out *ThanosStorage, s conversion.Scope) error {
	return autoConvert_config_ThanosStorage_To_v1_ThanosStorage(in, out, s)
}

func autoConvert_v1_ThanosStorageServer_To_config_ThanosStorageServer(in *ThanosStorageServer, out *config.ThanosStorageServer, s conversion.Scope) error {
	out.Address = in.Address
	return nil
}
...
func Convert_v1_ThanosStorageServer_To_config_ThanosStorageServer(in *ThanosStorageServer, out *config.ThanosStorageServer, s conversion.Scope) error {
	return autoConvert_v1_ThanosStorageServer_To_config_ThanosStorageServer(in, out, s)
}

func autoConvert_config_ThanosStorageServer_To_v1_ThanosStorageServer(in *config.ThanosStorageServer, out *ThanosStorageServer, s conversion.Scope) error {
	out.Address = in.Address
	return nil
}
...
func Convert_config_ThanosStorageServer_To_v1_ThanosStorageServer(in *config.ThanosStorageServer, out *ThanosStorageServer, s conversion.Scope) error {
	return autoConvert_config_ThanosStorageServer_To_v1_ThanosStorageServer(in, out, s)
}

...
func (Strategy) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	binding.Spec.Finalizers = []auth.FinalizerName{
		auth.CustomPolicyBindingFinalize,
	}

	binding.ObjectMeta.GenerateName = "cpb-"
	if binding.Spec.PolicyID != "" {
		binding.ObjectMeta.Name = binding.Spec.PolicyID
	} else {
...
func (s *Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateProjectPolicyBinding(ctx, obj.(*auth.CustomPolicyBinding), s.authClient)
}
...
func (s *Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateProjectPolicyBindingUpdate(ctx, obj.(*auth.CustomPolicyBinding), old.(*auth.CustomPolicyBinding), s.authClient)
}

// GetAttrs returns labels and fields of a given object for filtering purposes.
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	binding, ok := obj.(*auth.CustomPolicyBinding)
	if !ok {
		return nil, nil, fmt.Errorf("not a custompolicybinding")
	}
...
func ToSelectableFields(binding *auth.CustomPolicyBinding) fields.Set {
	...
	specificFieldsSet := fields.Set{
		"spec.domain":   binding.Spec.Domain,
...
func ShouldDeleteDuringUpdate(ctx context.Context, key string, obj, existing runtime.Object) bool {
	pol, ok := obj.(*auth.CustomPolicyBinding)
	if !ok {
...
func (StatusStrategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newBinding := obj.(*auth.CustomPolicyBinding)
	oldBinding := old.(*auth.CustomPolicyBinding)

...
func (s *Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateImageNamespaceCreate(obj.(*business.ImageNamespace), s.businessClient, s.registryClient)
}
...
func (s *Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateImageNamespaceUpdate(obj.(*business.ImageNamespace), old.(*business.ImageNamespace), s.businessClient, s.registryClient)
}
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	...
	return labels.Set(imageNamespace.Labels), ToSelectableFields(imageNamespace), nil
}

...
func ValidateConfigMap(configmap *business.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *business.ConfigMap, old *business.ConfigMap) field.ErrorList {

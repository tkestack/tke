...
func Install(scheme *runtime.Scheme) {
	runtimeutil.Must(addToGroupVersion(scheme))
}
...
func addToGroupVersion(scheme *runtime.Scheme) error {
	...
	scheme.AddKnownTypes(metainternal.SchemeGroupVersion,
	...
	scheme.AddUnversionedTypes(metainternal.SchemeGroupVersion,
		&metav1.DeleteOptions{},
		&metav1.CreateOptions{},
		&metav1.UpdateOptions{})

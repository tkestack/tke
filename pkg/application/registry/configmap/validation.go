...
func ValidateConfigMap(configmap *application.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *application.ConfigMap, old *application.ConfigMap) field.ErrorList {

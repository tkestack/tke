...
// Strategy implements verification logic for upgradejob.
...
// Validate validates a new upgradejob.
func (Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateUpgradeJob(obj.(*application.UpgradeJob))
}
...
func (Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateUpgradeJobUpdate(obj.(*application.UpgradeJob), old.(*application.UpgradeJob))
}

...
// Strategy implements verification logic for upgradepolicy.
...
func NewStrategy() *Strategy {
	return &Strategy{application.Scheme, namesutil.Generator}
}
...
// Validate validates a new upgradepolicy.
func (Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateUpgradePolicy(obj.(*application.UpgradePolicy))
}
...
func (Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateUpgradePolicyUpdate(obj.(*application.UpgradePolicy), old.(*application.UpgradePolicy))
}

...
func (r *EventREST) Get(ctx context.Context, name string, options *metav1.GetOptions) (runtime.Object, error) {
	...
	selector := fields.AndSelectors(
		fields.OneTermEqualSelector("involvedObject.uid", string(rc.UID)),
		fields.OneTermEqualSelector("involvedObject.name", rc.Name),
		fields.OneTermEqualSelector("involvedObject.namespace", rc.Namespace),
		fields.OneTermEqualSelector("involvedObject.kind", "ReplicationController"))

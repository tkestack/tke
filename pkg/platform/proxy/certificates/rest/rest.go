...
import (
	...
	certstorage "tkestack.io/tke/pkg/platform/proxy/certificates/certificatesigningrequest/storage"
)
...
func (s *StorageProvider) v1Beta1Storage(restOptionsGetter generic.RESTOptionsGetter, loopbackClientConfig *restclient.Config) map[string]rest.Storage {
	...
	certStore := certstorage.NewStorageV1Beta1(restOptionsGetter, platformClient)

	storageMap := map[string]rest.Storage{
		"certificatesigningrequests": certStore.PriorityClass,
	}

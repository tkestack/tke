...
func NewStorageV1Beta1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	certStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &certV1Beta1.CertificateSigningRequest{} },
		NewListFunc:    func() runtime.Object { return &certV1Beta1.CertificateSigningRequestList{} },
		Namespaced:     false,
		PlatformClient: platformClient,
	}

	return &Storage{
		PriorityClass: &REST{certStore},
	}
}

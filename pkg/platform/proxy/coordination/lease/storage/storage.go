...
func NewStorageV1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	leaseStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &coordinationV1.Lease{} },
		NewListFunc:    func() runtime.Object { return &coordinationV1.LeaseList{} },
		Namespaced:     true,
		PlatformClient: platformClient,
	}

	return &Storage{
		Lease: &REST{leaseStore},
	}
}
...
func NewStorageV1Beta1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	leaseStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &coordinationV1Beta1.Lease{} },
		NewListFunc:    func() runtime.Object { return &coordinationV1Beta1.LeaseList{} },
		Namespaced:     true,
		PlatformClient: platformClient,
	}

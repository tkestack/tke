...
func NewStorageV1Beta1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	webhookStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &admissionV1Beta1.ValidatingWebhookConfiguration{} },
		NewListFunc:    func() runtime.Object { return &admissionV1Beta1.ValidatingWebhookConfigurationList{} },
		Namespaced:     false,
		PlatformClient: platformClient,
	}

	return &Storage{
		RuntimeClass: &REST{webhookStore},
	}
}

...
import (
	...
	eventstorage "tkestack.io/tke/pkg/platform/proxy/events/event/storage"
)
...
func (s *StorageProvider) v1Beta1Storage(restOptionsGetter generic.RESTOptionsGetter, loopbackClientConfig *restclient.Config) map[string]rest.Storage {
	...
	eventStore := eventstorage.NewStorageV1Beta1(restOptionsGetter, platformClient)

	storageMap := map[string]rest.Storage{
		"events": eventStore.PriorityClass,
	}

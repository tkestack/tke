...
func NewStorageV1Alpha1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	rbacStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &rbacV1Alpha1.ClusterRole{} },
		NewListFunc:    func() runtime.Object { return &rbacV1Alpha1.ClusterRoleList{} },
		Namespaced:     false,
...
func NewStorageV1Beta1(_ genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface) *Storage {
	rbacStore := &proxy.Store{
		NewFunc:        func() runtime.Object { return &rbacV1Beta1.ClusterRole{} },
		NewListFunc:    func() runtime.Object { return &rbacV1Beta1.ClusterRoleList{} },
		Namespaced:     false,
		PlatformClient: platformClient,
	}

...
func ValidateConfigMap(configmap *platform.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *platform.ConfigMap, old *platform.ConfigMap) field.ErrorList {

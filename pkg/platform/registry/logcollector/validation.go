...
func ValidateLogCollector(ctx context.Context, platformClient platforminternalclient.PlatformInterface, decorator *platform.LogCollector) field.ErrorList {
...
func ValidateLogCollectorUpdate(ctx context.Context, platformClient platforminternalclient.PlatformInterface, new *platform.LogCollector, old *platform.LogCollector) field.ErrorList {
	allErrs := apiMachineryValidation.ValidateObjectMetaUpdate(&new.ObjectMeta, &old.ObjectMeta, field.NewPath("metadata"))
	allErrs = append(allErrs, ValidateLogCollector(ctx, platformClient, new)...)

...
func (s *Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateLogCollector(ctx, s.platformClient, obj.(*platform.LogCollector))
}
...
func (s *Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateLogCollectorUpdate(ctx, s.platformClient, obj.(*platform.LogCollector), old.(*platform.LogCollector))
}

...
import (
	...
	"tkestack.io/tke/pkg/platform/registry/secret"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter) *Storage {
	strategy := secret.NewStrategy()
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &platformv1.Secret{} },
		NewListFunc:              func() runtime.Object { return &platformv1.SecretList{} },
		DefaultQualifiedResource: platform.Resource("secrets"),
	...
	if err := store.CompleteWithOptions(options); err != nil {
		log.Panic("Failed to create secret etcd rest storage", log.Err(err))
	}

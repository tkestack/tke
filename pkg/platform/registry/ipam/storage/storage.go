...
import (
	...
	"tkestack.io/tke/pkg/platform/registry/ipam"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter, platformClient platforminternalclient.PlatformInterface, privilegedUsername string) *Storage {
	strategy := ipam.NewStrategy(platformClient)
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &platform.IPAM{} },
		NewListFunc:              func() runtime.Object { return &platform.IPAMList{} },
		DefaultQualifiedResource: platform.Resource("ipams"),
		PredicateFunc:            ipam.MatchIPAM,
	...
	statusStore := *store
	statusStore.UpdateStrategy = ipam.NewStatusStrategy(strategy)
	statusStore.ExportStrategy = ipam.NewStatusStrategy(strategy)

	return &Storage{
		IPAM:   &REST{store, privilegedUsername},
		Status: &StatusREST{&statusStore},
	}
}

// ValidateGetObjectAndTenantID validate name and tenantID, if success return IPAM
func ValidateGetObjectAndTenantID(ctx context.Context, store *registry.Store, name string, options *metav1.GetOptions) (runtime.Object, error) {
	...
	im := obj.(*platform.IPAM)
	if err := util.FilterIPAM(ctx, im); err != nil {
		return nil, err
	}
	return im, nil
}

// ValidateExportObjectAndTenantID validate name and tenantID, if success return IPAM
...
func (r *REST) DeleteCollection(ctx context.Context, deleteValidation rest.ValidateObjectFunc, options *metav1.DeleteOptions, listOptions *metainternal.ListOptions) (runtime.Object, error) {
	if !authentication.IsAdministrator(ctx, r.privilegedUsername) {
		return nil, errors.NewMethodNotSupported(platform.Resource("ipams"), "delete collection")
	}

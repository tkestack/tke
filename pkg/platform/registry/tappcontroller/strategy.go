...
func (s *Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateTappController(ctx, s.platformClient, obj.(*platform.TappController))
}
...
func (s *Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateTappControllerUpdate(ctx, s.platformClient, obj.(*platform.TappController), old.(*platform.TappController))
}

...
func (l *Logger) WithContext(ctx context.Context) *Entry {
	return &Entry{logger: l.logger.With(zap.Any("context", ctx)), Logger: l}
}

func (l *Logger) WithTime(t time.Time) *Entry {
	return &Entry{logger: l.logger.With(zap.Time("time", t)), Logger: l}
}

// WithField return a logger with an extra field.
func (l *Logger) WithField(key string, value interface{}) *Entry {
	return &Entry{logger: l.logger.With(zap.Any(key, value)), Logger: l}
}

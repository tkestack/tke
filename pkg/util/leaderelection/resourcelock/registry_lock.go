...
import (
	...
	registryv1client "tkestack.io/tke/api/client/clientset/versioned/typed/registry/v1"
	v1 "tkestack.io/tke/api/registry/v1"
)

// RegistryConfigMapLock defines the structure of using configmap resources to implement
// distributed locks.
...
func (cml *RegistryConfigMapLock) Get(ctx context.Context) (*LeaderElectionRecord, error) {
...
func (cml *RegistryConfigMapLock) Create(ctx context.Context, ler LeaderElectionRecord) error {
...
func (cml *RegistryConfigMapLock) Update(ctx context.Context, ler LeaderElectionRecord) error {
	if cml.cm == nil {

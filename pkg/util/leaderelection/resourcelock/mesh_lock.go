...
import (
	...
	meshv1client "tkestack.io/tke/api/client/clientset/versioned/typed/mesh/v1"
	v1 "tkestack.io/tke/api/mesh/v1"
)

// MeshConfigMapLock defines the structure of using configmap resources to implement
// distributed locks.
...
func (cml *MeshConfigMapLock) Get(ctx context.Context) (*LeaderElectionRecord, error) {
...
func (cml *MeshConfigMapLock) Create(ctx context.Context, ler LeaderElectionRecord) error {
...
func (cml *MeshConfigMapLock) Update(ctx context.Context, ler LeaderElectionRecord) error {
	if cml.cm == nil {

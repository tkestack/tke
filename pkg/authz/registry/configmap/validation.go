...
func ValidateConfigMap(configmap *authz.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *authz.ConfigMap, old *authz.ConfigMap) field.ErrorList {

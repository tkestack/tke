...
// Utility functions for the Monitor's meshconfig API group

// NewSchemeAndCodecs is a utility function that returns a Scheme and CodecFactory
// that understand the types in the meshconfig API group.
func NewSchemeAndCodecs() (*runtime.Scheme, *serializer.CodecFactory, error) {
	scheme := runtime.NewScheme()
	if err := meshconfig.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}
	if err := meshconfigv1.AddToScheme(scheme); err != nil {
		return nil, nil, err
	}

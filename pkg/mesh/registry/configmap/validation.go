...
func ValidateConfigMap(configmap *mesh.ConfigMap) field.ErrorList {
...
func ValidateConfigMapUpdate(configmap *mesh.ConfigMap, old *mesh.ConfigMap) field.ErrorList {
